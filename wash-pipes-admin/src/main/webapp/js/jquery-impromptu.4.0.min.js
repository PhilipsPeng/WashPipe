...
(function($) {
    $.prompt = function(message, options) {
        ...
        function(statename, stateobj) {
            stateobj = $.extend({},
            $.prompt.defaults.state, stateobj);
        ...
        function(statename, stateobj) {
            ...
            $state.children('.' + $.prompt.options.prefix + 'buttons').children('button').click(function() {
                ...
                var forminputs = {};
                $.each($.prompt.jqi.find('#' + $.prompt.options.prefix + 'states :input').serializeArray(),
                function(i, obj) {
    ...
    $.prompt.setStateDefaults = function(o) {
        $.prompt.defaults.state = $.extend({},
        $.prompt.defaults.state, o);
    };
    ...
    $.prompt.goToState = function(state, callback) {
        ...
        if (!promptstatechanginge.isDefaultPrevented()) {
            ...
            $('#' + $.prompt.currentPrefix + '_state_' + state).slideDown('slow',
            function() {
                var $t = $(this);
