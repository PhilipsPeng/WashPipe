...
(function(b) {
    ...
    b.extend(b.jgrid, {
        ...
        parseDate: function(f, e) {
            ...
            if (e && null !== e && void 0 !== e) {
                ...
                var f = f.split(d),
                i = b.jgrid.formatter.date.monthNames,
                ...
                d = 0;
                for (a = f.length; d < a; d++)"M" == f[d] && (g = b.inArray(e[d], i), -1 !== g && 12 > g && (e[d] = g + 1, c.m = e[d])),
                "F" == f[d] && (g = b.inArray(e[d], i), -1 !== g && 11 < g && (e[d] = g + 1 - 12, c.m = e[d])),
                "a" == f[d] && (g = b.inArray(e[d], h), -1 !== g && 2 > g && e[d] == h[g] && (e[d] = g, c.h = j(e[d], c.h))),
                "A" == f[d] && (g = b.inArray(e[d], h), -1 !== g && 1 < g && e[d] == h[g] && (e[d] = g - 2, c.h = j(e[d], c.h))),
                void 0 !== e[d] && (c[f[d].toLowerCase()] = parseInt(e[d], 10));
        ...
        getAccessor: function(b, e) {
            ...
            c = b[e];
            if (void 0 === c) try {
                if ("string" === typeof e && (a = e.split(".")), g = a.length) for (c = b; c && g--;) d = a.shift(),
                c = c[d]
            } catch(i) {}
            return c
        },
        ...
        from: function(f) {
            ...
            function(e, c) {
                ...
                y = [],
                n = !0;
                if ("object" == typeof e && e.push) 0 < e.length && (n = "object" != typeof e[0] ? !1 : !0);
                ...
                this._repeatCommand = function(a, b) {
                    return null === l ? d: null !== a && null !== b ? l(a, b) : null === k || !n ? l(a) : l(k, a)
                };
                ...
                this._compare = function(a, b, d) {
                    ...
                    if (null !== a && null === b) return - 1;
                    if ("[object Date]" === c.call(a) && "[object Date]" === c.call(b)) return a < b ? -d: a > b ? d: 0; ! g && "number" !== typeof a && "number" !== typeof b && (a = ("" + a).toLowerCase(), b = ("" + b).toLowerCase());
                    return a < b ? -d: a > b ? d: 0
                };
                this._performSort = function() {
                    0 !== y.length && (a = d._doSort(a, 0))
                };
                this._doSort = function(a, b) {
                    ...
                    f = y[b].type,
                    e = y[b].datefmt;
                    if (b == y.length - 1) return d._getOrder(a, c, g, f, e);
                    b++;
                    c = d._getGroup(a, c, g, f, e);
                    g = [];
                    for (f = 0; f < c.length; f++) for (var e = d._doSort(c[f].items, b), i = 0; i < e.length; i++) g.push(e[i]);
                    return g
                };
                this._getOrder = function(a, c, g, f, e) {
                    var i = [],
                    h = [],
                    l = "a" == g ? 1 : -1,
                    k,
                    m;
                    void 0 === f && (f = "text");
                    m = "float" == f || "number" == f || "currency" == f || "numeric" == f ?
                    function(a) {
                    ...
                    for (var f = 0, p = a.length; f < p;) g = h[f].index,
                    i.push(a[g]),
                    f++;
                    return i
                };
                this._getGroup = function(a, c, f, g, e) {
                    var i = [],
                    h = null,
                    j = null,
                    k;
                    b.each(d._getOrder(a, c, f, g, e),
                    function(a, f) {
                        k = b.jgrid.getAccessor(f, c);
                        void 0 === k && (k = "");
                        d._equals(j, k) || (j = k, null !== h && i.push(h), h = d._group(c, k));
                        h.items.push(f)
                    });
                    null !== h && i.push(h);
                    return i
                ...
                this._compareValues = function(a, c, f, g, e) {
                    var i;
                    i = n ? "jQuery.jgrid.getAccessor(this,'" + c + "')": "this";
                    void 0 === f && (f = null);
                    var h = f,
                    ...
                    case "datetime":
                        ...
                        i = 'jQuery.jgrid.parseDate("' + e.srcfmt + '",' + i + ").getTime()";
                        break;
                    default:
                        i = d._getStr(i),
                ...
                this.startsWith = function(a, c) {
                    var g = void 0 === c || null === c ? a: c,
                    g = f ? b.trim(g.toString()).length: g.toString().length;
                    n ? d._append(d._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + ".substr(0," + g + ") == " + d._getStr('"' + d._toStr(c) + '"')) : (g = f ? b.trim(c.toString()).length: c.toString().length, d._append(d._getStr("this") + ".substr(0," + g + ") == " + d._getStr('"' + d._toStr(a) + '"')));
                ...
                this.endsWith = function(a, c) {
                    var g = void 0 === c || null === c ? a: c,
                    g = f ? b.trim(g.toString()).length: g.toString().length;
                    n ? d._append(d._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + ".substr(" + d._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + ".length-" + g + "," + g + ') == "' + d._toStr(c) + '"') : d._append(d._getStr("this") + ".substr(" + d._getStr("this") + '.length-"' + d._toStr(a) + '".length,"' + d._toStr(a) + '".length) == "' + d._toStr(a) + '"');
                    d._setCommand(d.endsWith, a);
                    d._resetNegate();
                    return d
                };
                this.contains = function(a, b) {
                    n ? d._append(d._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + '.indexOf("' + d._toStr(b) + '",0) > -1') : d._append(d._getStr("this") + '.indexOf("' + d._toStr(a) + '",0) > -1');
                    d._setCommand(d.contains, a);
                    d._resetNegate();
                    return d
                };
                this.groupBy = function(b, c, f, g) {
                    return ! d._hasData() ? null: d._getGroup(a, b, c, f, g)
                };
                this.orderBy = function(a, c, f, g) {
                    c = void 0 === c || null === c ? "a": b.trim(c.toString().toLowerCase());
                    if (null === f || void 0 === f) f = "text";
                    if (null === g || void 0 === g) g = "Y-m-d";
            ...
            if (!this.grid) {
                ...
                c = {
                    ...
                    populateVisible: function() {
                        ...
                        if (a) {
                            ...
                            if (G) {
                                ...
                                G *= h;
                                var z, s, x;
                                if (k < a && 0 >= j && (void 0 === d.lastpage || parseInt((k + f + G - 1) / G, 10) <= d.lastpage)) s = parseInt((a - k + G - 1) / G, 10),
                                0 <= k || 2 > s || !0 === d.scroll ? (z = Math.round((k + f) / G) + 1, j = -1) : j = 1;
                                0 < j && (z = parseInt(f / G, 10) + 1, s = parseInt((f + a) / G, 10) + 2 - z, x = !0);
                                if (s && !(d.lastpage && z > d.lastpage || 1 == d.lastpage || z === d.page && z === d.lastpage)) c.hDiv.loading ? c.timer = setTimeout(c.populateVisible, d.scrollTimeout) : (d.page = z, x && (c.selectionPreserver(e[0]), c.emptyRows(c.bDiv, !1, !1)), c.populate(s))
                            }
                        }
                    },
                    ...
                    selectionPreserver: function(a) {
                        ...
                        i = function() {
                            ...
                            b(a).unbind(".selectionPreserver", i)
                        };
                        b(a).bind("jqGridGridComplete.selectionPreserver", i)
                    }
                };
                if ("TABLE" != this.tagName.toUpperCase()) alert("Element is not a table");
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
                        ...
                        var o = b("<div class='ui-jqgrid ui-widget ui-widget-content ui-corner-all'></div>");
                        b(o).insertBefore(j).attr({
                            id: "gbox_" + this.id,
                            dir: h
                        });
                        b(j).appendTo(o).attr("id", "gview_" + this.id);
                        ...
                        y = function(d, e, f, i, h, j) {
                            var J = a.p.colModel[d],
                            k = J.align,
                            z = 'style="',
                            s = J.classes,
                            x = J.name,
                            r = [];
                            k && (z = z + ("text-align:" + k + ";"));
                            J.hidden === true && (z = z + "display:none;");
                            if (e === 0) z = z + ("width: " + c.headers[d].width + "px;");
                            else if (J.cellattr && b.isFunction(J.cellattr)) if ((d = J.cellattr.call(a, h, f, i, J, j)) && typeof d === "string") {
                                d = d.replace(/style/i, "style").replace(/title/i, "title");
                                if (d.indexOf("title") > -1) J.title = false;
                            ...
                            z = z + ((s !== void 0 ? ' class="' + s + '"': "") + (J.title && f ? ' title="' + b.jgrid.stripHtml(f) + '"': ""));
                            z = z + (' aria-describedby="' + a.p.id + "_" + x + '"');
                            return z + r[0]
                        },
                        n = function(c) {
                            return c === void 0 || c === null || c === "" ? "&#160;": a.p.autoencode ? b.jgrid.htmlEncode(c) : c + ""
                        },
                        H = function(c, d, e, f, i) {
                            var g = a.p.colModel[e];
                            if (typeof g.formatter !== "undefined") {
                                c = {
                                    rowId: c,
                                    colModel: g,
                                    gid: a.p.id,
                                ...
                                d = b.isFunction(g.formatter) ? g.formatter.call(a, d, c, f, i) : b.fmatter ? b.fn.fmatter.call(a, g.formatter, d, c, f, i) : n(d)
                            } else d = n(d);
                            return d
                        },
                        E = function(a, b, c, d, e) {
                            b = H(a, b, c, e, "add");
                            return '<td role="gridcell" ' + y(c, d, b, e, a, true) + ">" + b + "</td>"
                        },
                        O = function(b, c, d) {
                            var e = '<input role="checkbox" type="checkbox" id="jqg_' + a.p.id + "_" + b + '" class="cbox" name="jqg_' + a.p.id + "_" + b + '"/>';
                            return '<td role="gridcell" ' + y(c, d, "", null, b, true) + ">" + e + "</td>"
                        },
                        T = function(a, b, c, d) {
                            c = (parseInt(c, 10) - 1) * parseInt(d, 10) + 1 + b;
                            return '<td role="gridcell" class="ui-state-default jqgrid-rownum" ' + y(a, b, c, null, b, true) + ">" + c + "</td>"
                        },
                        aa = function(b) {
                            var c, d = [],
                            e = 0,
                        ...
                        Q = function(c, d, e) {
                            if (a.p.deepempty) b("#" + b.jgrid.jqID(a.p.id) + " tbody:first tr:gt(0)").remove();
                                ...
                                var f = b("#" + b.jgrid.jqID(a.p.id) + " tbody:first tr:first")[0];
                        ...
                        Y = function(c, d, e, f, i) {
                            ...
                            if (!b.isEmptyObject(f)) {
                                ...
                                for (j in f) f.hasOwnProperty(j) && (h = h + (" " + j + "=" + f[j]))
                            }
                        ...
                        ba = function(c, d, e, f, g) {
                            ...
                            if (b.isXMLDoc(c)) {
                                ...
                                w,
                                n = [],
                                y = a.p.altRows === true ? " " + a.p.altclass: "",
                                u;
                                j.repeatitems || (o = aa(k));
                                K = a.p.keyIndex === false ? b.isFunction(j.id) ? j.id.call(a, c) : j.id: a.p.keyIndex;
                                if (o.length > 0 && !isNaN(K)) {
                                    a.p.remapColumns && a.p.remapColumns.length && (K = b.inArray(K, a.p.remapColumns));
                                    K = o[K]
                                }
                                k = (K + "").indexOf("[") === -1 ? o.length ?
                                function(a, c) {
                                    return b(K, a).text() || c
                                }: function(a, c) {
                                    return b(j.cell, a).eq(K).text() || c
                                }: function(a, b) {
                                    return a.getAttribute(K.replace(/[\[\]]/g, "")) || b
                                };
                                a.p.userData = {};
                                ...
                                if (c && L) {
                                    var C = a.p.scroll ? b.jgrid.randId() : 1;
                                    g && (A = A * (g + 1));
                                    for (var g = b.isFunction(a.p.afterInsertRow), F = a.p.grouping && a.p.groupingView.groupCollapse === true; q < L;) {
                                        t = c[q];
                                        w = k(t, C + q);
                                        w = a.p.idPrefix + w;
                                        s = e === 0 ? 0 : e + 1;
                                        ...
                                        var D = n.length;
                                        n.push("");
                                        I && n.push(T(0, q, a.p.page, a.p.rowNum));
                                        m && n.push(O(w, I, q));
                                        p && n.push(b(a).jqGrid("addSubGridCell", m + I, q + e));
                                        if (j.repeatitems) {
                                            U || (U = P(m + p + I));
                                            var H = b.jgrid.getXmlData(t, j.cell, true);
                                            b.each(U,
                                            function(b) {
                                                var c = H[this];
                                                if (!c) return false;
                                                l = c.textContent || c.text;
                                                B[a.p.colModel[b + m + p + I].name] = l;
                                                n.push(E(w, l, b + m + p + I, q + e, t))
                                            })
                                        } else for (s = 0; s < o.length; s++) {
                                            l = b.jgrid.getXmlData(t, o[s]);
                                            B[a.p.colModel[s + m + p + I].name] = l;
                                            n.push(E(w, l, s + m + p + I, q + e, t))
                                        }
                                        n[D] = Y(w, F, u, B, t);
                                        n.push("</tr>");
                                        if (a.p.grouping) {
                                            ...
                                            u = [];
                                            for (D = 0; D < s; D++) u.push(B[a.p.groupingView.groupField[D]]);
                                            v = b(a).jqGrid("groupingPrepare", n, u, v, B);
                                            n = []
                                        }
                                        ...
                                        if (a.p.gridview === false) {
                                            b("tbody:first", d).append(n.join(""));
                                            b(a).triggerHandler("jqGridAfterInsertRow", [w, B, t]);
                                ...
                                if (a.p.gridview === true) {
                                    ...
                                    if (a.p.grouping) {
                                        ...
                                        v = null
                                    } else a.p.treeGrid === true && x > 0 ? b(a.rows[x]).after(n.join("")) : b("tbody:first", d).append(n.join(""))
                                }
                                if (a.p.subGrid === true) try {
                                    b(a).jqGrid("addSubGrid", m + I)
                                } catch(M) {}
                                a.p.totaltime = new Date - i;
                                if (r > 0 && a.p.records === 0) a.p.records = L;
                                n = null;
                                if (a.p.treeGrid === true) try {
                                    b(a).jqGrid("setTreeNode", x + 1, r + x + 1)
                                } catch(R) {}
                        ...
                        da = function(c, d, e, f, g) {
                            ...
                            if (c) {
                                ...
                                o = b.jgrid.getAccessor(c, d.total);
                                a.p.lastpage = o === void 0 ? 1 : o;
                                a.p.records = b.jgrid.getAccessor(c, d.records) || 0;
                                a.p.userData = b.jgrid.getAccessor(c, d.userdata) || {};
                                d.repeatitems || (l = r = aa(h));
                                h = a.p.keyIndex === false ? b.isFunction(d.id) ? d.id.call(a, c) : d.id: a.p.keyIndex;
                                if (r.length > 0 && !isNaN(h)) {
                                    a.p.remapColumns && a.p.remapColumns.length && (h = b.inArray(h, a.p.remapColumns));
                                    h = r[h]
                                } (u = b.jgrid.getAccessor(c, d.root)) || (u = []);
                                o = u.length;
                                c = 0;
                                if (o > 0 && a.p.page <= 0) a.p.page = 1;
                                var A = parseInt(a.p.rowNum, 10),
                                L = a.p.scroll ? b.jgrid.randId() : 1;
                                g && (A = A * (g + 1));
                                for (var D = b.isFunction(a.p.afterInsertRow), C = {},
                                F = a.p.grouping && a.p.groupingView.groupCollapse === true; c < o;) {
                                    g = u[c];
                                    t = b.jgrid.getAccessor(g, h);
                                    if (t === void 0) {
                                        t = L + c;
                                        if (r.length === 0 && d.cell) {
                                            s = b.jgrid.getAccessor(g, d.cell);
                                            t = s !== void 0 ? s[h] || t: t
                                        }
                                    }
                                    t = a.p.idPrefix + t;
                                    ...
                                    var H = w.length;
                                    w.push("");
                                    n && w.push(T(0, c, a.p.page, a.p.rowNum));
                                    m && w.push(O(t, n, c));
                                    p && w.push(b(a).jqGrid("addSubGridCell", m + n, c + e));
                                    if (d.repeatitems) {
                                        d.cell && (g = b.jgrid.getAccessor(g, d.cell));
                                        l || (l = P(m + p + n))
                                    }
                                    for (x = 0; x < l.length; x++) {
                                        s = b.jgrid.getAccessor(g, l[x]);
                                        w.push(E(t, s, x + m + p + n, c + e, g));
                                        q[a.p.colModel[x + m + p + n].name] = s
                                    }
                                    w[H] = Y(t, F, v, q, g);
                                    w.push("</tr>");
                                    if (a.p.grouping) {
                                        s = a.p.groupingView.groupField.length;
                                        x = [];
                                        for (v = 0; v < s; v++) x.push(q[a.p.groupingView.groupField[v]]);
                                        C = b(a).jqGrid("groupingPrepare", w, x, C, q);
                                        w = []
                                    }
                                    ...
                                    if (a.p.gridview === false) {
                                        ...
                                        b(a).triggerHandler("jqGridAfterInsertRow", [t, q, g]);
                                        D && a.p.afterInsertRow.call(a, t, q, g);
                                        w = []
                                    }
                                    q = {};
                                    k++;
                                ...
                                if (a.p.gridview === true) {
                                    ...
                                    a.p.grouping ? b(a).jqGrid("groupingRender", C, a.p.colModel.length) : a.p.treeGrid === true && B > 0 ? b(a.rows[B]).after(w.join("")) : b("#" + b.jgrid.jqID(a.p.id) + " tbody:first").append(w.join(""))
                                }
                                if (a.p.subGrid === true) try {
                                    b(a).jqGrid("addSubGrid", m + n)
                                } catch(M) {}
                                a.p.totaltime = new Date - i;
                                if (k > 0 && a.p.records === 0) a.p.records = o;
                                if (a.p.treeGrid === true) try {
                                ...
                                if (j) for (; k < o && u[k];) {
                                    ...
                                    if (t === void 0) {
                                        t = L + k;
                                        r.length === 0 && d.cell && (t = b.jgrid.getAccessor(g, d.cell)[h] || t)
                                    }
                                    if (g) {
                                        t = a.p.idPrefix + t;
                                        if (d.repeatitems) {
                        ...
                        na = function() {
                            function c(d) {
                                var e = 0,
                                g, h, i, j, S;
                                if (d.groups !== void 0) { (h = d.groups.length && d.groupOp.toString().toUpperCase() === "OR") && r.orBegin();
                                ...
                                if (d.rules !== void 0) {
                                    ...
                                    try { (i = d.rules.length && d.groupOp.toString().toUpperCase() === "OR") && r.orBegin();
                                        for (g = 0; g < d.rules.length; g++) {
                                            S = d.rules[g];
                                            j = d.groupOp.toString().toUpperCase();
                                            if (x[S.op] && S.field) {
                                                e > 0 && j && j === "OR" && (r = r.or());
                                                r = x[S.op](r, j)(S.field, S.data, f[S.field])
                                            }
                                            e++
                                        }
                                        i && r.orEnd()
                                ...
                                if (a.p.treeGrid) b(a).jqGrid("SortTree", d, a.p.sortorder, f[d].stype, f[d].srcfmt);
                                    ...
                                    if (a.p.search === true) {
                                        ...
                                        if (m) {
                                            ...
                                            r = x[a.p.postData.searchOper](r)(a.p.postData.searchField, a.p.postData.searchString, f[a.p.postData.searchField])
                                        } catch(n) {}
                                    }
                                    if (a.p.grouping) {
                                        r.orderBy(h, l.groupOrder[0], g[0].stype, g[0].srcfmt);
                                        l.groupDataSorted = true
                                    }
                                    d && a.p.sortorder && e && (a.p.sortorder.toUpperCase() == "DESC" ? r.orderBy(a.p.sortname, "d", f[d].stype, f[d].srcfmt) : r.orderBy(a.p.sortname, "a", f[d].stype, f[d].srcfmt));
                                    var m = r.select(),
                                    p = parseInt(a.p.rowNum, 10),
                                    o = m.length,
                                    q = parseInt(a.p.page, 10),
                                    u = Math.ceil(o / p),
                                    v = {},
                                    m = m.slice((q - 1) * p, q * p),
                                    f = r = null;
                                    v[a.p.localReader.total] = u;
                                    v[a.p.localReader.page] = q;
                                    v[a.p.localReader.records] = o;
                                    ...
                                    case "script":
                                        b.ajax(b.extend({
                                            ...
                                            success: function(e, g, h) {
                                                ...
                                                f === "xml" ? ba(e, a.grid.bDiv, k, c > 1, j) : da(e, a.grid.bDiv, k, c > 1, j);
                        ...
                        l = function(c, d) {
                            ...
                            h == "rtl" && (f = f + g);
                            a.p.pginput === true && (e = "<td dir='" + h + "'>" + b.jgrid.format(a.p.pgtext || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + b.jgrid.jqID(c) + "'></span>") + "</td>");
                        ...
                        pa = function(c) {
                            ...
                            a.p.toppager && (e[1] = e[1] + (b(a.grid.topDiv).height() + parseInt(b(a.grid.topDiv).css("border-bottom-width"), 10)));
                        ...
                        a.p.keyIndex = !1;
                        for (e = 0; e < a.p.colModel.length; e++) a.p.colModel[e] = b.extend(!0, {},
                        a.p.cmTemplate, a.p.colModel[e].template || {},
                        a.p.colModel[e]),
                        !1 === a.p.keyIndex && !0 === a.p.colModel[e].key && (a.p.keyIndex = e);
                        a.p.sortorder = a.p.sortorder.toLowerCase(); ! 0 === a.p.grouping && (a.p.scroll = !1, a.p.rownumbers = !1, a.p.subGrid = !1, a.p.treeGrid = !1, a.p.gridview = !0);
                        ...
                        "horizontal" == a.p.viewsortcols[1] && (V = " ui-i-asc", R = " ui-i-desc");
                        ma = k ? "class='ui-th-div-ie'": "";
                        V = "<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc" + V + " ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-" + h + "'></span>" + ("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + R + " ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-" + h + "'></span></span>");
                        for (e = 0; e < this.p.colNames.length; e++) R = a.p.headertitles ? ' title="' + b.jgrid.stripHtml(a.p.colNames[e]) + '"': "",
                        A += "<th id='" + a.p.id + "_" + a.p.colModel[e].name + "' role='columnheader' class='ui-state-default ui-th-column ui-th-" + h + "'" + R + ">",
                        R = a.p.colModel[e].index || a.p.colModel[e].name,
                        A += "<div id='jqgh_" + a.p.id + "_" + a.p.colModel[e].name + "' " + ma + ">" + a.p.colNames[e],
                        a.p.colModel[e].width = a.p.colModel[e].width ? parseInt(a.p.colModel[e].width, 10) : 150,
                        "boolean" !== typeof a.p.colModel[e].title && (a.p.colModel[e].title = !0),
                        R == a.p.sortname && (a.p.lastsort = e),
                        A += V + "</div></th>";
                        V = null;
                        ...
                        if (this.p.multiselect) {
                            ...
                            function() {
                                ...
                                b(a).triggerHandler("jqGridSelectAll", [W ? a.p.selarrrow: ha, W]);
                                b.isFunction(a.p.onSelectAll) && a.p.onSelectAll.call(a, W ? a.p.selarrrow: ha, W)
                            })
                        } ! 0 === a.p.autowidth && (A = b(o).innerWidth(), a.p.width = 0 < A ? A: "nw");
                        (function() {
                            var d = 0,
                            e = m ? 0 : p(a.p.cellLayout, 0),
                            f = 0,
                            i,
                            h = p(a.p.scrollOffset, 0),
                            j,
                            k = false,
                            l,
                            n = 0,
                            ...
                            function() {
                                ...
                                this.widthOrg = j = p(this.width, 0);
                            ...
                            if (a.p.shrinkToFit === true && f > 0) {
                                ...
                                q = 0;
                                k ? c.width - n - (d + e * f) !== h && (q = c.width - n - (d + e * f) - h) : !k && Math.abs(c.width - n - (d + e * f)) !== 1 && (q = c.width - n - (d + e * f));
                                a.p.colModel[i].width = a.p.colModel[i].width + q;
                                a.p.tblwidth = d + q + e * f + n;
                                if (a.p.tblwidth > a.p.width) {
                                    a.p.colModel[i].width = a.p.colModel[i].width - (a.p.tblwidth - parseInt(a.p.width, 10));
                                    a.p.tblwidth = a.p.width
                                }
                            }
                        })();
                        b(o).css("width", c.width + "px").append("<div class='ui-jqgrid-resize-mark' id='rs_m" + a.p.id + "'>&#160;</div>");
                        b(j).css("width", c.width + "px");
                        var A = b("thead:first", a).get(0),
                        N = "";
                        a.p.footerrow && (N += "<table role='grid' style='width:" + a.p.tblwidth + "px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-" + h + "'>");
                        var j = b("tr:first", A),
                        ...
                        b("th", j).each(function(d) {
                            ...
                            if (a.p.colModel[d].resizable) {
                                ...
                                b($).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + h);
                                b.browser.opera || b($).css("cursor", "col-resize");
                                b(this).addClass(a.p.resizeclass)
                            } else $ = "";
                            b(this).css("width", fa + "px").prepend($);
                            var e = "";
                            if (a.p.colModel[d].hidden) {
                                b(this).css("display", "none");
                                e = "display:none;"
                            }
                            X = X + ("<td role='gridcell' style='height:0px;width:" + fa + "px;" + e + "'></td>");
                            c.headers[d] = {
                                width: fa,
                                el: this
                            };
                            ...
                            a.p.footerrow && (N = N + ("<td role='gridcell' " + y(d, 0, "", null, "", false) + ">&#160;</td>"))
                        ...
                        var X = null,
                        j = b("<table class='ui-jqgrid-htable' style='width:" + a.p.tblwidth + "px' role='grid' aria-labelledby='gbox_" + this.id + "' cellspacing='0' cellpadding='0' border='0'></table>").append(A),
                        C = a.p.caption && !0 === a.p.hiddengrid ? !0 : !1;
                        ...
                        a.p.pager && ("string" == typeof a.p.pager ? "#" != a.p.pager.substr(0, 1) && (a.p.pager = "#" + a.p.pager) : a.p.pager = "#" + b(a.p.pager).attr("id"), b(a.p.pager).css({
                            width: c.width + "px"
                        }).appendTo(o).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom"), C && b(a.p.pager).hide(), l(a.p.pager, "")); ! 1 === a.p.cellEdit && !0 === a.p.hoverrows && b(a).bind("mouseover",
                        function(a) {
                        ...
                        b(a).before(c.hDiv).click(function(c) {
                            q = c.target;
                            u = b(q, a.rows).closest("tr.jqgrow");
                            if (b(u).length === 0 || u[0].className.indexOf("ui-state-disabled") > -1 || (b(q, a).closest("table.ui-jqgrid-btable").attr("id") || "").replace("_frozen", "") !== a.id) return this;
                            var d = b(q).hasClass("cbox"),
                            e = b(a).triggerHandler("jqGridBeforeSelectRow", [u[0].id, c]);
                            (e = e === false || e === "stop" ? false: true) && b.isFunction(a.p.beforeSelectRow) && (e = a.p.beforeSelectRow.call(a, u[0].id, c));
                            if (! (q.tagName == "A" || (q.tagName == "INPUT" || q.tagName == "TEXTAREA" || q.tagName == "OPTION" || q.tagName == "SELECT") && !d) && e === true) {
                                v = u[0].id;
                                D = b.jgrid.getCellIndex(q);
                                ia = b(q).closest("td,th").html();
                                b(a).triggerHandler("jqGridCellSelect", [v, D, ia, c]);
                                b.isFunction(a.p.onCellSelect) && a.p.onCellSelect.call(a, v, D, ia, c);
                                if (a.p.cellEdit === true) if (a.p.multiselect && d) b(a).jqGrid("setSelection", v, true, c);
                                else {
                                    v = u[0].rowIndex;
                                    try {
                                        b(a).jqGrid("editCell", v, D, true)
                                    } catch(f) {}
                                } else if (a.p.multikey) if (c[a.p.multikey]) b(a).jqGrid("setSelection", v, true, c);
                                else {
                        ...
                        function(c, d) {
                            ...
                            a.p.scroll && Q(a.grid.bDiv, true, false);
                            if (d && d.page) {
                                var e = d.page;
                            ...
                            if (b(u).length !== 0) {
                                v = u[0].rowIndex;
                                D = b.jgrid.getCellIndex(q);
                                b(a).triggerHandler("jqGridDblClickRow", [b(u).attr("id"), v, D, c]);
                                b.isFunction(this.p.ondblClickRow) && a.p.ondblClickRow.call(a, b(u).attr("id"), v, D, c)
                            }
                        }).bind("contextmenu",
                        function(c) {
                            q = c.target;
                            ...
                            if (b(u).length !== 0) {
                                ...
                                v = u[0].rowIndex;
                                D = b.jgrid.getCellIndex(q);
                                b(a).triggerHandler("jqGridRightClickRow", [b(u).attr("id"), v, D, c]);
                                b.isFunction(this.p.onRightClickRow) && a.p.onRightClickRow.call(a, b(u).attr("id"), v, D, c)
                            }
                        });
                        ...
                        k ? (2 == b("tbody", this).size() && b("tbody:gt(0)", this).remove(), a.p.multikey && b(c.bDiv).bind("selectstart",
                        function() {
                            return false
                        })) : a.p.multikey && b(c.bDiv).bind("mousedown",
                        function() {
                            return false
                        });
                        C && b(c.bDiv).hide();
                        c.cDiv = document.createElement("div");
                        var ja = !0 === a.p.hidegrid ? b("<a role='link' href='javascript:void(0)'/>").addClass("ui-jqgrid-titlebar-close HeaderButton").hover(function() {
                        ...
                        b(c.cDiv).append(ja).append("<span class='ui-jqgrid-title" + ("rtl" == h ? "-rtl": "") + "'>" + a.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix");
                        b(c.cDiv).insertBefore(c.hDiv);
                        a.p.toolbar[0] && (c.uDiv = document.createElement("div"), "top" == a.p.toolbar[1] ? b(c.uDiv).insertBefore(c.hDiv) : "bottom" == a.p.toolbar[1] && b(c.uDiv).insertAfter(c.hDiv), "both" == a.p.toolbar[1] ? (c.ubDiv = document.createElement("div"), b(c.uDiv).insertBefore(c.hDiv).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id), b(c.ubDiv).insertAfter(c.hDiv).addClass("ui-userdata ui-state-default").attr("id", "tb_" + this.id), C && b(c.ubDiv).hide()) : b(c.uDiv).width(c.width).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id), C && b(c.uDiv).hide());
                        ...
                        a.p.footerrow && (c.sDiv = b("<div class='ui-jqgrid-sdiv'></div>")[0], e = b("<div class='ui-jqgrid-hbox" + ("rtl" == h ? "-rtl": "") + "'></div>"), b(c.sDiv).append(e).insertAfter(c.hDiv).width(c.width), b(e).append(N), c.footers = b(".ui-jqgrid-ftable", c.sDiv)[0].rows[0].cells, a.p.rownumbers && (c.footers[0].className = "ui-state-default jqgrid-rownum"), C && b(c.sDiv).hide());
                        e = null;
                        if (a.p.caption) {
                            ...
                            var qa = a.p.datatype; ! 0 === a.p.hidegrid && (b(".ui-jqgrid-titlebar-close", c.cDiv).click(function(d) {
                                ...
                                i = b(f, "#gview_" + b.jgrid.jqID(a.p.id)).length;
                                ...
                                function() {
                                    ...
                                    if (i === 0) {
                                        ...
                                        e && (C || a.p.onHeaderClick.call(a, a.p.gridstate, d))
                                    }
                                ...
                                return false
                            }), C && (a.p.datatype = "local", b(".ui-jqgrid-titlebar-close", c.cDiv).trigger("click")))
                        } else b(c.cDiv).hide();
                        ...
                        a.updatepager = function(c, d) {
                            ...
                            if (l = l + (a.p.toppager ? l ? "," + a.p.toppager: a.p.toppager: "")) {
                                ...
                                if (a.p.pginput === true) {
                                    ...
                                    i = a.p.toppager ? "#sp_1" + m + ",#sp_1" + n: "#sp_1" + m;
                                    b(i).html(b.fmatter ? b.fmatter.util.NumberFormat(a.p.lastpage, k) : a.p.lastpage)
                                }
                                if (a.p.viewrecords)
    ...
    b.jgrid.extend({
        ...
        getDataIDs: function() {
            ...
            d = 0;
            this.each(function() {
                if ((c = this.rows.length) && 0 < c) for (; e < c;) b(this.rows[e]).hasClass("jqgrow") && (f[d] = this.rows[e].id, d++),
                e++
            });
            return f
        },
        setSelection: function(f, e, c) {
            return this.each(function() {
                ...
                if (void 0 !== f && (e = !1 === e ? !1 : !0, (a = this.rows.namedItem(f + "")) && a.className && !( - 1 < a.className.indexOf("ui-state-disabled"))))(!0 === this.p.scrollrows && (g = this.rows.namedItem(f).rowIndex, 0 <= g && (d = b(this.grid.bDiv)[0].clientHeight, i = b(this.grid.bDiv)[0].scrollTop, h = this.rows[g].offsetTop, g = this.rows[g].clientHeight, h + g >= d + i ? b(this.grid.bDiv)[0].scrollTop = h - (d + i) + g + i: h < d + i && h < i && (b(this.grid.bDiv)[0].scrollTop = h))), !0 === this.p.frozenColumns && (j = this.p.id + "_frozen"), this.p.multiselect) ? (this.setHeadCheckBox(!1), this.p.selrow = a.id, i = b.inArray(this.p.selrow, this.p.selarrrow), -1 === i ? ("ui-subgrid" !== a.className && b(a).addClass("ui-state-highlight").attr("aria-selected", "true"), d = !0, this.p.selarrrow.push(this.p.selrow)) : ("ui-subgrid" !== a.className && b(a).removeClass("ui-state-highlight").attr("aria-selected", "false"), d = !1, this.p.selarrrow.splice(i, 1), h = this.p.selarrrow[0], this.p.selrow = void 0 === h ? null: h), b("#jqg_" + b.jgrid.jqID(this.p.id) + "_" + b.jgrid.jqID(a.id))[this.p.useProp ? "prop": "attr"]("checked", d), j && ( - 1 === i ? b("#" + b.jgrid.jqID(f), "#" + b.jgrid.jqID(j)).addClass("ui-state-highlight") : b("#" + b.jgrid.jqID(f), "#" + b.jgrid.jqID(j)).removeClass("ui-state-highlight"), b("#jqg_" + b.jgrid.jqID(this.p.id) + "_" + b.jgrid.jqID(f), "#" + b.jgrid.jqID(j))[this.p.useProp ? "prop": "attr"]("checked", d)), b(this).triggerHandler("jqGridSelectRow", [a.id, d, c]), this.p.onSelectRow && e && this.p.onSelectRow.call(this, a.id, d, c)) : "ui-subgrid" !== a.className && (this.p.selrow != a.id ? (b(this.rows.namedItem(this.p.selrow)).removeClass("ui-state-highlight").attr({
                    ...
                    "aria-selected": "true",
                    tabindex: "0"
                }), j && (b("#" + b.jgrid.jqID(this.p.selrow), "#" + b.jgrid.jqID(j)).removeClass("ui-state-highlight"), b("#" + b.jgrid.jqID(f), "#" + b.jgrid.jqID(j)).addClass("ui-state-highlight")), d = !0) : d = !1, this.p.selrow = a.id, b(this).triggerHandler("jqGridSelectRow", [a.id, d, c]), this.p.onSelectRow && e && this.p.onSelectRow.call(this, a.id, d, c))
            })
        },
        resetSelection: function(f) {
            return this.each(function() {
                var e = this,
                c, d, a; ! 0 === e.p.frozenColumns && (a = e.p.id + "_frozen");
                ...
                }), e.setHeadCheckBox(!1), e.p.selarrrow = []) : e.p.selrow && (b("#" + b.jgrid.jqID(e.p.id) + " tbody:first tr#" + b.jgrid.jqID(e.p.selrow)).removeClass("ui-state-highlight").attr("aria-selected", "false"), a && b("#" + b.jgrid.jqID(e.p.selrow), "#" + b.jgrid.jqID(a)).removeClass("ui-state-highlight"), e.p.selrow = null); ! 0 === e.p.cellEdit && 0 <= parseInt(e.p.iCol, 10) && 0 <= parseInt(e.p.iRow, 10) && (b("td:eq(" + e.p.iCol + ")", e.rows[e.p.iRow]).removeClass("edit-cell ui-state-highlight"), b(e.rows[e.p.iRow]).removeClass("selected-row ui-state-hover"));
                e.p.savedRow = []
            })
        },
        getRowData: function(f) {
            ...
            this.each(function() {
                var i = this,
                h, j;
                if ("undefined" == typeof f) d = !0,
                c = [],
                a = i.rows.length;
                else {
                    j = i.rows.namedItem(f);
                    if (!j) return e;
                    a = 2
                }
                for (; g < a;) d && (j = i.rows[g]),
                b(j).hasClass("jqgrow") && (b('td[role="gridcell"]', j).each(function(a) {
                    h = i.p.colModel[a].name;
                    if ("cb" !== h && "subgrid" !== h && "rn" !== h) if (!0 === i.p.treeGrid && h == i.p.ExpandColumn) e[h] = b.jgrid.htmlDecode(b("span:first", this).html());
                    else try {
                        e[h] = b.unformat.call(i, this, {
                            rowId: j.id,
            ...
            this.each(function() {
                ...
                if (e) try {
                    if (b(this.p.colModel).each(function(a) {
                        d = this.name;
                        void 0 !== e[d] && (k[d] = this.formatter && "string" === typeof this.formatter && "date" == this.formatter ? b.unformat.date.call(i, e[d], this) : e[d], h = i.formatter(f, e[d], a, e, "edit"), g = this.title ? {
                            title: b.jgrid.stripHtml(h)
                        }: {},
                        !0 === i.p.treeGrid && d == i.p.ExpandColumn ? b("td:eq(" + a + ") > span:first", j).html(h).attr(g) : b("td:eq(" + a + ")", j).html(h).attr(g))
                    }), "local" == i.p.datatype) {
                        var m = b.jgrid.stripPref(i.p.idPrefix, f),
                        o = i.p._index[m];
                        if (i.p.treeGrid) for (var p in i.p.treeReader) k.hasOwnProperty(i.p.treeReader[p]) && delete k[i.p.treeReader[p]];
                        "undefined" != typeof o && (i.p.data[o] = b.extend(!0, i.p.data[o], k));
                        k = null
                    }
                } catch(y) {
                    a = !1
                }
                a && ("string" === l ? b(j).addClass(c) : "object" === l && b(j).css(c), b(i).triggerHandler("jqGridAfterGridComplete"))
            });
            return a
        },
        addRowData: function(f, e, c, d) {
            ...
            g, i, h, j, l, k, m, o, p = "",
            y, n, H, E, O, T;
            e && (b.isArray(e) ? (y = !0, c = "last", n = f) : (e = [e], y = !1), this.each(function() {
                var aa = e.length;
                l = this.p.rownumbers === true ? 1 : 0;
                h = this.p.multiselect === true ? 1 : 0;
                j = this.p.subGrid === true ? 1 : 0;
                if (!y) if (typeof f != "undefined") f = f + "";
                else {
                    f = b.jgrid.randId();
                    if (this.p.keyIndex !== false) {
                        n = this.p.colModel[this.p.keyIndex + h + j + l].name;
                        typeof e[0][n] != "undefined" && (f = e[0][n])
                    }
                }
                H = this.p.altclass;
                for (var P = 0, Q = "", F = {}, Y = b.isFunction(this.p.afterInsertRow) ? true: false; P < aa;) {
                    E = e[P];
                    i = [];
                    if (y) {
                        try {
                    ...
                    if (l) {
                        ...
                        i[i.length] = '<td role="gridcell" aria-describedby="' + this.p.id + '_rn" class="ui-state-default jqgrid-rownum" ' + p + ">0</td>"
                    }
                    if (h) {
                        o = '<input role="checkbox" type="checkbox" id="jqg_' + this.p.id + "_" + f + '" class="cbox"/>';
                        p = this.formatCol(l, 1, "", null, f, true);
                        i[i.length] = '<td role="gridcell" aria-describedby="' + this.p.id + '_cb" ' + p + ">" + o + "</td>"
                    }
                    j && (i[i.length] = b(this).jqGrid("addSubGridCell", h + l, 1));
                    for (m = h + j + l; m < this.p.colModel.length; m++) {
                        O = this.p.colModel[m];
                        g = O.name;
                        F[g] = O.formatter && typeof O.formatter === "string" && O.formatter == "date" ? b.unformat.date.call(this, E[g], O) : E[g];
                        o = this.formatter(f, b.jgrid.getAccessor(E, g), m, E, "edit");
                        p = this.formatCol(m, 1, o, E, f, true);
                        i[i.length] = '<td role="gridcell" aria-describedby="' + this.p.id + "_" + g + '" ' + p + ">" + o + "</td>"
                    }
                    i.unshift(this.constructTr(f, false, Q, F, F));
                    i[i.length] = "</tr>";
                    if (this.rows.length === 0) b("table:first", this.grid.bDiv).append(i.join(""));
                    else switch (c) {
                    case "last":
                        b(this.rows[this.rows.length - 1]).after(i.join(""));
                        k = this.rows.length - 1;
                        break;
                    case "first":
                        b(this.rows[0]).after(i.join(""));
                        k = 1;
                        break;
                    case "after":
                        (k = this.rows.namedItem(d)) && (b(this.rows[k.rowIndex + 1]).hasClass("ui-subgrid") ? b(this.rows[k.rowIndex + 1]).after(i) : b(k).after(i.join("")));
                        k++;
                        break;
                    case "before":
                    ...
                    Y && this.p.afterInsertRow.call(this, f, E, E);
                    P++;
                    if (this.p.datatype == "local") {
                        F[this.p.localReader.id] = T;
                        this.p._index[T] = this.p.data.length;
                        this.p.data.push(F);
                        F = {}
                    }
                }
                this.p.altRows === true && !y && (c == "last" ? (this.rows.length - 1) % 2 == 1 && b(this.rows[this.rows.length - 1]).addClass(H) : b(this.rows).each(function(a) {
                    a % 2 == 1 ? b(this).addClass(H) : b(this).removeClass(H)
                }));
        ...
        footerData: function(f, e, c) {
            ...
            this.each(function() {
                ...
                b(this.p.colModel).each(function(d) {
                    ...
                    b("tr.footrow td:eq(" + d + ")", j.grid.sDiv).html(l).attr(h), g = !0) : "get" == f && (i[a] = b("tr.footrow td:eq(" + d + ")", j.grid.sDiv).html())
                })
            });
            return "get" == f ? i: g
        },
                ...
                if (c.grid) {
                    ...
                    b(this.p.colModel).each(function(h) {
                        if ( - 1 !== b.inArray(this.name, f) && this.hidden === i) {
                            ...
                            g = this.widthOrg ? this.widthOrg: parseInt(this.width, 10);
                            c.p.tblwidth = "none" === e ? c.p.tblwidth - (g + a) : c.p.tblwidth + (g + a);
                            this.hidden = !i;
                            d = !0;
                            b(c).triggerHandler("jqGridShowHideCol", [i, this.name, h])
                        }
        ...
        remapColumns: function(f, e, c) {
            ...
            g.p.remapColumns && (g.p.remapColumns.length ? d(g.p.remapColumns) : g.p.remapColumns = b.makeArray(f));
        ...
        setGridWidth: function(f, e) {
            return this.each(function() {
                if (this.grid) {
                    var c = this,
                    d, a = 0,
                    g = b.browser.webkit || b.browser.safari ? 0 : c.p.cellLayout,
                    i,
                    h = 0,
                    j = !1,
                    l = c.p.scrollOffset,
                    ...
                    if (!isNaN(f)) {
                        ...
                        c.p.footerrow && b(c.grid.sDiv).css("width", f + "px"); ! 1 === e && !0 === c.p.forceFit && (c.p.forceFit = !1);
                        if (!0 === e) {
                            b.each(c.p.colModel,
                            function() {
                                if (this.hidden === false) {
                            ...
                            k -= l;
                            var a = 0,
                            y = 0 < c.grid.cols.length;
                            b.each(c.p.colModel,
                            function(b) {
                                if (this.hidden === false && !this.fixed) {
                                    d = this.widthOrg ? this.widthOrg: parseInt(this.width, 10);
                                    d = Math.round(k * d / (c.p.tblwidth - g * h - m));
                                    if (! (d < 0)) {
                                        this.width = d;
                                        a = a + d;
                                        ...
                                        if (y) c.grid.cols[b].style.width = d + "px";
                                        i = b
                                    }
                                }
                            });
                            if (!i) return;
                            p = 0;
                            j ? f - m - (a + g * h) !== l && (p = f - m - (a + g * h) - l) : 1 !== Math.abs(f - m - (a + g * h)) && (p = f - m - (a + g * h));
                            c.p.colModel[i].width += p;
                            c.p.tblwidth = a + p + g * h + m;
                            c.p.tblwidth > f ? (j = c.p.tblwidth - parseInt(f, 10), c.p.tblwidth = f, d = c.p.colModel[i].width -= j) : d = c.p.colModel[i].width;
                            c.grid.headers[i].width = d;
                            c.grid.headers[i].el.style.width = d + "px";
                            y && (c.grid.cols[i].style.width = d + "px");
                            c.p.footerrow && (c.grid.footers[i].style.width = d + "px")
                        }
        ...
        setLabel: function(f, e, c, d) {
            return this.each(function() {
                ...
                if (this.grid && "undefined" != typeof f && (b(this.p.colModel).each(function(b) {
                    ...
                    if (e) {
                        var i = b(".s-ico", g);
                        b("[id^=jqgh_]", g).empty().html(e).append(i);
                        this.p.colNames[a] = e
                    }
                    c && ("string" === typeof c ? b(g).addClass(c) : b(g).css(c));
                    "object" === typeof d && b(g).attr(d)
                }
            })
        },
        setCell: function(f, e, c, d, a, g) {
            return this.each(function() {
                ...
                if (this.grid && (isNaN(e) ? b(this.p.colModel).each(function(a) {
                    if (this.name == e) return i = a,
                    !1
                }) : i = parseInt(e, 10), 0 <= i && (h = this.rows.namedItem(f)))) {
                    var l = b("td:eq(" + i + ")", h);
                    if ("" !== c || !0 === g) h = this.formatter(f, c, i, h, "edit"),
                    j = this.p.colModel[i].title ? {
                        title: b.jgrid.stripHtml(h)
                    }: {},
                    this.p.treeGrid && 0 < b(".tree-wrap", b(l)).length ? b("span", b(l)).html(h).attr(j) : b(l).html(h).attr(j),
                    "local" == this.p.datatype && (h = this.p.colModel[i], c = h.formatter && "string" === typeof h.formatter && "date" == h.formatter ? b.unformat.date.call(this, c, h) : c, j = this.p._index[f], "undefined" != typeof j && (this.p.data[j][h.name] = c));
                    ...
                    if (k && 0 < k) {
                        for (; m < k;) {
                            if (b(this.rows[m]).hasClass("jqgrow")) {
                                ...
                                c ? (j = parseFloat(a), g += j, 0 === m ? h = i = j: (i = Math.min(i, j), h = Math.max(h, j))) : e ? d.push({
                                    id: this.rows[m].id,
                                    value: a
                                }) : d.push(a)
                            }
        ...
        getInd: function(b, e) {
            var c = !1,
            d;
            this.each(function() { (d = this.rows.namedItem(b)) && (c = !0 === e ? d: d.rowIndex)
            });
            return c
        },
        bindKeys: function(f) {
            ...
            return this.each(function() {
                ...
                b(c).keydown(function(d) {
                    ...
                    if (a) if (h = c.p._index[a.id], 37 === d.keyCode || 38 === d.keyCode || 39 === d.keyCode || 40 === d.keyCode) {
                        if (38 === d.keyCode) {
                            i = a.previousSibling;
                            f = "";
                            if (i) if (b(i).is(":hidden")) for (; i;) {
                                if (i = i.previousSibling, !b(i).is(":hidden") && b(i).hasClass("jqgrow")) {
                                    f = i.id;
                                    break
                                }
                            } else f = i.id;
                        ...
                        if (40 === d.keyCode) {
                            ...
                            f = "";
                            if (i) if (b(i).is(":hidden")) for (; i;) {
                                if (i = i.nextSibling, !b(i).is(":hidden") && b(i).hasClass("jqgrow")) {
                                    f = i.id;
                                    break
                                }
                            } else f = i.id;
                        ...
                        39 === d.keyCode && (c.p.treeGrid && !c.p.data[h][j] && b(a).find("div.treeclick").trigger("click"), b(c).triggerHandler("jqGridKeyRight", [c.p.selrow]), b.isFunction(e.onRightKey) && e.onRightKey.call(c, c.p.selrow))
                    } 
...
(function(b) {
    ...
    b.extend(b.fmatter, {
        ...
        isEmpty: function(a) {
            if (!this.isString(a) && this.isValue(a)) return ! 1;
    ...
    b.fmatter.util = {
        ...
        DateFormat: function(a, c, f, d) {
            ...
            g = "string" === typeof c ? c.match(e) : null,
            e = function(a, b) {
                a = "" + a;
            ...
            else if (null !== g) i = new Date(parseInt(g[1], 10)),
            g[3] && (a = 60 * Number(g[5]) + Number(g[6]), a *= "-" == g[4] ? 1 : -1, a -= i.getTimezoneOffset(), i.setTime(Number(Number(i) + 6E4 * a)));
            else {
                c = ("" + c).split(/[\\\/:_;.,\t\T\s-]/);
                a = a.split(/[\\\/:_;.,\t\T\s-]/);
                g = 0;
                for (j = a.length; g < j; g++)"M" == a[g] && (i = b.inArray(c[g], k.i18n.monthNames), -1 !== i && 12 > i && (c[g] = i + 1)),
                "F" == a[g] && (i = b.inArray(c[g], k.i18n.monthNames), -1 !== i && 11 < i && (c[g] = i + 1 - 12)),
                c[g] && (h[a[g].toLowerCase()] = parseInt(c[g], 10));
                h.f && (h.m = h.f);
            ...
            f in d.masks ? f = d.masks[f] : f || (f = "Y-m-d");
            a = i.getHours();
            c = i.getMinutes();
            h = i.getDate();
            g = i.getMonth() + 1;
    ...
    b.fn.fmatter.checkbox = function(a, c) {
        ...
        c.checkbox),
        d;
        b.fmatter.isUndefined(c.colModel.formatoptions) || (f = b.extend({},
    ...
    b.fn.fmatter.link = function(a, c) {
        ...
        return ! b.fmatter.isEmpty(a) ? "<a " + d + ' href="' + a + '">' + a + "</a>": b.fn.fmatter.defaultFormat(a, c)
    };
    ...
    b.fn.fmatter.select = function(a, c) {
        ...
        if (f) {
            ...
            i = [];
            h && (i = a.split(","), i = b.map(i,
            function(a) {
                return b.trim(a)
            }));
            if (b.fmatter.isString(f)) for (var j = f.split(g), k = 0, l = 0; l < j.length; l++) if (g = j[l].split(e), 2 < g.length && (g[1] = b.map(g,
            function(a, b) {
                if (b > 0) return a
            ...
            } else b.fmatter.isObject(f) && (h ? d = b.map(i,
            function(a) {
                return f[a]
            }) : d[0] = f[a] || "")
        }
    ...
    b.fn.fmatter.rowactions = function(a, c, f, d) {
        ...
        var g = b("#" + c)[0],
        d = function(d, f) {
            b.isFunction(e.afterSave) && e.afterSave.call(g, d, f);
        ...
        case "edit":
            ...
            break;
        case "save":
            b("#" + c).jqGrid("saveRow", a, e.onSuccess, e.url, e.extraparam, d, e.onError, h) && (b("tr#" + a + " div.ui-inline-edit, tr#" + a + " div.ui-inline-del", "#" + c + ".ui-jqgrid-btable:first").show(), b("tr#" + a + " div.ui-inline-save, tr#" + a + " div.ui-inline-cancel", "#" + c + ".ui-jqgrid-btable:first").hide(), b(g).triggerHandler("jqGridAfterGridComplete"));
            break;
        case "cancel":
        ...
        case "formedit":
            ...
            b("#" + c).jqGrid("editGridRow", a, e.editOptions)
        }
    };
    b.fn.fmatter.actions = function(a, c) {
        ...
        g = "onclick=jQuery.fn.fmatter.rowactions('" + d + "','" + c.gid + "','save'," + c.pos + "); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); ";
        e = e + "<div title='" + b.jgrid.edit.bSubmit + "' style='float:left;display:none' class='ui-pg-div ui-inline-save' " + g + "><span class='ui-icon ui-icon-disk'></span></div>";
        g = "onclick=jQuery.fn.fmatter.rowactions('" + d + "','" + c.gid + "','cancel'," + c.pos + "); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); ";
        e = e + "<div title='" + b.jgrid.edit.bCancel + "' style='float:left;display:none;margin-left:5px;' class='ui-pg-div ui-inline-cancel' " + g + "><span class='ui-icon ui-icon-cancel'></span></div>";
    ...
    b.unformat = function(a, c, f, d) {
        ...
        else if (!b.fmatter.isUndefined(g) && b.fmatter.isString(g)) switch (e = b.jgrid.formatter || {},
        g) {
        case "integer":
            h = b.extend({},
            e.integer, h);
    ...
    b.unformat.select = function(a, c, f, d) {
        ...
        if (!0 === d) return a;
        var d = b.extend({},
        !b.fmatter.isUndefined(c.colModel.formatoptions) ? c.colModel.formatoptions: c.colModel.editoptions),
        ...
        if (d.value) {
            ...
            d = !0 === d.multiple ? !0 : !1,
            h = [];
            d && (h = a.split(","), h = b.map(h,
            function(a) {
                return b.trim(a)
            }));
            if (b.fmatter.isString(g)) for (var i = g.split(e), j = 0, k = 0; k < i.length; k++) if (e = i[k].split(c), 2 < e.length && (e[1] = b.map(e,
            function(a, b) {
                if (b > 0) return a
            ...
            } else if (b.fmatter.isObject(g) || b.isArray(g)) d || (h[0] = a),
            f = b.map(h,
            function(a) {
                var c;
                b.each(g,
    ...
    b.unformat.date = function(a, c) {
        ...
        b.fmatter.isUndefined(c.formatoptions) || (f = b.extend({},
        f, c.formatoptions));
        return ! b.fmatter.isEmpty(a) ? b.fmatter.util.DateFormat(f.newformat, a, f.srcformat, f) : b.fn.fmatter.defaultFormat(a, c)
    }
})(jQuery);
(function(a) {
    a.jgrid.extend({
        ...
        sortGrid: function(a, d, c) {
            return this.each(function() {
                ...
                if (this.grid) {
                    a || (a = this.p.sortname);
                    for (var h = 0; h < this.p.colModel.length; h++) if (this.p.colModel[h].index == a || this.p.colModel[h].name == a) {
                        e = h;
                        break
                ...
                if (!this.ftoolbar) {
                    var e = function() {
                        ...
                        function() {
                            ...
                            if (g = a("#gs_" + a.jgrid.jqID(this.name), !0 === this.frozen && !0 === c.p.frozenColumns ? c.grid.fhDiv: c.grid.hDiv).val()) d[f] = g,
                            h[f] = m,
                            j++;
                            else try {
                        ...
                        var r = "stop" === a(c).triggerHandler("jqGridToolbarBeforeSearch") ? !0 : !1; ! r && a.isFunction(b.beforeSearch) && (r = b.beforeSearch.call(c));
                    ...
                    function() {
                        ...
                        j = a("<div style='width:100%;position:relative;height:100%;padding-right:0.3em;'></div>"); ! 0 === this.hidden && a(q).css("display", "none");
                        ...
                        case "select":
                            ...
                            a.jgrid.ajaxOptions, c.p.ajaxSelectOptions || {}));
                                ...
                                var m, o, k;
                                i.searchoptions ? (m = void 0 === i.searchoptions.value ? "": i.searchoptions.value, o = void 0 === i.searchoptions.separator ? ":": i.searchoptions.separator, k = void 0 === i.searchoptions.delimiter ? ";": i.searchoptions.delimiter) : i.editoptions && (m = void 0 === i.editoptions.value ? "": i.editoptions.value, o = void 0 === i.editoptions.separator ? ":": i.editoptions.separator, k = void 0 === i.editoptions.delimiter ? ";": i.editoptions.delimiter);
                                if (m) {
                                    ...
                                    if ("string" === typeof m) {
                                        m = m.split(k);
                                        for (var p = 0; p < m.length; p++) l = m[p].split(o),
                                    ...
                                    a(j).append(n); ! 0 === b.autosearch && a(n).change(function() {
                                        e();
                                        return false
                                    })
                                }
                            ...
                            break;
                        case "text":
                            o = void 0 !== f.defaultValue ? f.defaultValue: "",
                            a(j).append("<input type='text' style='width:95%;padding:0px;' name='" + (i.index || i.name) + "' id='gs_" + i.name + "' value='" + o + "'/>"),
                            f.attr && a("input", j).attr(f.attr),
                            void 0 !== f.dataInit && f.dataInit(a("input", j)[0]),
                            void 0 !== f.dataEvents && d(a("input", j)[0], f.dataEvents),
                    ...
                    this.clearToolbar = function(d) {
                        ...
                        function() {
                            ...
                            case "select":
                                ...
                                break;
                            case "text":
                                if (a("#gs_" + a.jgrid.jqID(this.name), !0 === this.frozen && !0 === c.p.frozenColumns ? c.grid.fhDiv: c.grid.hDiv).val(b), void 0 !== b) j[f] = b,
                                g++;
                                else try {
                                    delete c.p.postData[f]
                                } catch(e) {}
        ...
        destroyGroupHeader: function(b) {
            ...
            return this.each(function() {
                ...
                if (c) {
                    ...
                    a(j).prepend(d); ! 0 === b && a(this).jqGrid("setGridParam", {
                        groupHeader: null
                    })
                }
            })
                ...
                if (this.grid) {
                    ...
                    if (! (!0 === b.p.subGrid || !0 === b.p.treeGrid || !0 === b.p.cellEdit || b.p.sortable || b.p.scroll || b.p.grouping)) {
                        ...
                        if (0 <= h && g) {
                            ...
                            b.p.toppager && (d += a(b.grid.topDiv).outerHeight()); ! 0 === b.p.toolbar[0] && "bottom" != b.p.toolbar[1] && (d += a(b.grid.uDiv).outerHeight());
                            ...
                            function(c, d) {
                                ...
                                a(g).attr("aria-selected", "true"); ! b.p.viewsortcols[0] && b.p.lastsort != d && (a("span.s-ico", e).hide(), a("span.s-ico", g).show())
                            });
...
(function(a) {
    a.extend(a.jgrid, {
        ...
        createModal: function(d, b, c, f, g, h, i) {
            ...
            a(m).append(b);
            e.appendChild(m);
            a(e).prepend(k); ! 0 === h ? a("body").append(e) : "string" == typeof h ? a(h).append(e) : a(e).insertBefore(f);
            a(e).css(i);
            "undefined" === typeof c.jqModal && (c.jqModal = !0);
            b = {};
            if (a.fn.jqm && !0 === c.jqModal) 0 === c.left && 0 === c.top && c.overlay && (i = [], i = this.findPos(g), c.left = i[0] + 4, c.top = i[1] + 4),
            b.top = c.top + "px",
            b.left = c.left;
            ...
            if (c.drag) if (a(k).css("cursor", "move"), a.fn.jqDrag) a(e).jqDrag(k);
            else try {
                a(e).draggable({
        ...
        info_dialog: function(d, b, c, f) {
            ...
            a.fn.jqm && !h && (h = !1);
            d = "";
            if (0 < g.buttons.length) for (f = 0; f < g.buttons.length; f++)"undefined" == typeof g.buttons[f].id && (g.buttons[f].id = "info_button_" + f),
        ...
        createEl: function(d, b, c, f, g) {
            ...
            function i(b, d, c) {
                ...
                a.each(d,
                function(d, c) { - 1 === a.inArray(d, e) && a(b).attr(d, c)
                });
            ...
            case "checkbox":
                ...
                e.type = "checkbox";
                b.value ? (d = b.value.split(":"), c === d[0] && (e.checked = !0, e.defaultChecked = !0), e.value = d[0], a(e).attr("offval", d[1])) : (d = c.toLowerCase(), 0 > d.search(/(false|0|no|off|undefined)/i) && "" !== d ? (e.checked = !0, e.defaultChecked = !0, e.value = c) : e.value = "on", a(e).attr("offval", "off"));
                i(e, b, ["value"]);
                b = h(e, b);
            ...
            case "select":
                ...
                f = []; ! 0 === b.multiple ? (d = !0, e.multiple = "multiple", a(e).attr("aria-multiselectable", "true")) : d = !1;
                ...
                g || {}));
                    ...
                    d && (f = c.split(","), f = a.map(f,
                    function(b) {
                        return a.trim(b)
                    }));
                    "function" === typeof b.value && (b.value = b.value());
                    var k, n, m = void 0 === b.separator ? ":": b.separator,
            ...
            case "custom":
                ...
                try {
                    ...
                    "e1" == o && this.info_dialog(a.jgrid.errors.errcap, "function 'custom_element' " + a.jgrid.edit.msg.nodefined, a.jgrid.edit.bClose),
                    "e2" == o ? this.info_dialog(a.jgrid.errors.errcap, "function 'custom_element' " + a.jgrid.edit.msg.novalue, a.jgrid.edit.bClose) : this.info_dialog(a.jgrid.errors.errcap, "string" === typeof o ? o: o.message, a.jgrid.edit.bClose)
                }
            }
            return e
        },
        checkDate: function(a, b) {
            ...
            f = -1;
            for (var g, h = -1, i = -1, e = 0; e < a.length; e++) g = isNaN(b[e]) ? 0 : parseInt(b[e], 10),
            c[a[e]] = g,
            g = a[e],
            -1 != g.indexOf("y") && (f = e),
            -1 != g.indexOf("m") && (i = e),
        ...
        checkTime: function(a) {
            ...
            if (!this.isEmpty(a)) if (a = a.match(b)) {
                if (a[3]) {
        ...
        checkValues: function(d, b, c, f, g) {
            ...
            if (h) {
                ...
                if (!0 === h.time && !(!1 === f && this.isEmpty(d)) && !this.checkTime(d)) return [!1, i + ": " + a.jgrid.edit.msg.date + " - hh:mm (am/pm)", ""];
...
(function(a) {
    ...
    a.jgrid.extend({
        searchGrid: function(c) {
            ...
            return this.each(function() {
                function d(b) {
                    ...
                    r && (a.jgrid.viewModal("#" + a.jgrid.jqID(t.themodal), {
                ...
                if (e.grid) {
                    ...
                    s = e.p.postData[c.sFilter];
                    "string" === typeof s && (s = a.jgrid.parse(s)); ! 0 === c.recreateFilter && a("#" + a.jgrid.jqID(t.themodal)).remove();
                    if (null !== a("#" + a.jgrid.jqID(t.themodal)).html()) d(a("#fbox_" + a.jgrid.jqID( + e.p.id)));
                    else {
                        var p = a("<div><div id='" + l + "' class='searchFilter' style='overflow:auto'></div></div>").insertBefore("#gview_" + a.jgrid.jqID(e.p.id)),
                        g = "left",
                        f = "";
                        "rtl" == e.p.direction && (g = "right", f = " style='text-align:left'", p.attr("dir", "rtl"));
                        var n = a.extend([], e.p.colModel),
                        w = "<a href='javascript:void(0)' id='" + l + "_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'><span class='ui-icon ui-icon-search'></span>" + c.Find + "</a>",
                        b = "<a href='javascript:void(0)' id='" + l + "_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>" + c.Reset + "</a>",
                        m = "",
                        h = "",
                        k,
                        j = !1,
                        ...
                        c.columns.length ? n = c.columns: a.each(n,
                        function(a, b) {
                        ...
                        j = !1;
                        c.tmplNames && c.tmplNames.length && (j = !0, h = c.tmplLabel, h += "<select class='ui-template'>", h += "<option value='default'>Default</option>", a.each(c.tmplNames,
                        function(a, b) {
                            h = h + ("<option value='" + a + "'>" + b + "</option>")
                        }), h += "</select>");
                        g = "<table class='EditTable' style='border:0px none;margin-top:5px' id='" + l + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:" + g + "'>" + b + h + "</td><td class='EditButton' " + f + ">" + m + w + "</td></tr></tbody></table>";
                        l = a.jgrid.jqID(l);
                        a("#" + l).jqFilter({
                            columns: n,
                            filter: c.loadDefaults ? s: null,
                        ...
                        p.append(g);
                        j && c.tmplFilters && c.tmplFilters.length && a(".ui-template", p).bind("change",
                        function() {
                            var b = a(this).val();
                        ...
                        a(e).triggerHandler("jqGridFilterInitialize", [a("#" + l)]);
                        a.isFunction(c.onInitializeSearch) && c.onInitializeSearch.call(e, a("#" + l));
                        c.gbox = "#gbox_" + l;
                        c.layer ? a.jgrid.createModal(t, p, c, "#gview_" + a.jgrid.jqID(e.p.id), a("#gbox_" + a.jgrid.jqID(e.p.id))[0], "#" + a.jgrid.jqID(c.layer), {
                            position: "relative"
                        }) : a.jgrid.createModal(t, p, c, "#gview_" + a.jgrid.jqID(e.p.id), a("#gbox_" + a.jgrid.jqID(e.p.id))[0]);
                        ...
                        function() {
                            ...
                            if (c.stringResult) {
                                ...
                                if (typeof h === "string") {
                                    d[c.sFilter] = h;
                                    a.each([c.sField, c.sValue, c.sOper],
                                    function() {
                                        d[this] = ""
                                    })
                                }
        ...
        editGridRow: function(u, d) {
            ...
            return this.each(function() {
                        ...
                        if (d.length) {
                            ...
                            function() {
                                if (this.name === c && this.editoptions && a.isFunction(this.editoptions.custom_value)) {
                                    try {
                                        if (i[c] = this.editoptions.custom_value.call(b, a("#" + a.jgrid.jqID(c), j), "get"), void 0 === i[c]) throw "e1";
                                    } catch(d) {
                ...
                function l(d, e, h, q) {
                    ...
                    a(e.p.colModel).each(function(m) {
                        ...
                        if ("cb" !== i && "subgrid" !== i && !0 === this.editable && "rn" !== i) {
                            if (!1 === n) j = "";
                            else if (i == e.p.ExpandColumn && !0 === e.p.treeGrid) j = a("td:eq(" + m + ")", e.rows[n]).text();
                            else {
                                try {
                                    j = a.unformat.call(e, a("td:eq(" + m + ")", e.rows[n]), {
                                        rowId: d,
                                        colModel: this
                                    },
                                    m)
                                } catch(r) {
                                    j = this.edittype && "textarea" == this.edittype ? a("td:eq(" + m + ")", e.rows[n]).text() : a("td:eq(" + m + ")", e.rows[n]).html()
                                }
                            ...
                            this.formoptions || {}),
                            t = parseInt(s.rowpos, 10) || k + 1,
                            y = parseInt(2 * (parseInt(s.colpos, 10) || 1), 10);
                            ...
                            l = a.jgrid.createEl.call(b, this.edittype, v, j, !1, a.extend({},
                            ...
                            s.rowabove && (v = a("<tr><td class='contentinfo' colspan='" + 2 * q + "'>" + s.rowcontent + "</td></tr>"), a(h).append(v), v[0].rp = t);
                    ...
                    if (0 < k && (m = a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" + (2 * q - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='" + e.p.id + "_id' value='" + d + "'/></td></tr>"), m[0].rp = k + 999, a(h).append(m), c[b.p.id].checkOnSubmit || c[b.p.id].checkOnUpdate)) c[b.p.id]._savedData[e.p.id + "_id"] = d;
                    return p
                }
                function r(d, e, h) {
                    var i, q = 0,
                    g, f, k, o, l;
                    if (c[b.p.id].checkOnSubmit || c[b.p.id].checkOnUpdate) c[b.p.id]._savedData = {},
                    c[b.p.id]._savedData[e.p.id + "_id"] = d;
                    var m = e.p.colModel;
                    if ("_empty" == d) a(m).each(function() {
                        i = this.name;
                        k = a.extend({},
                        this.editoptions || {});
                        if ((f = a("#" + a.jgrid.jqID(i), "#" + h)) && f.length && null !== f[0]) if (o = "", k.defaultValue ? (o = a.isFunction(k.defaultValue) ? k.defaultValue.call(b) : k.defaultValue, "checkbox" == f[0].type ? (l = o.toLowerCase(), 0 > l.search(/(false|0|no|off|undefined)/i) && "" !== l ? (f[0].checked = !0, f[0].defaultChecked = !0, f[0].value = o) : (f[0].checked = !1, f[0].defaultChecked = !1)) : f.val(o)) : "checkbox" == f[0].type ? (f[0].checked = !1, f[0].defaultChecked = !1, o = a(f).attr("offval")) : f[0].type && "select" == f[0].type.substr(0, 6) ? f[0].selectedIndex = 0 : f.val(o), !0 === c[b.p.id].checkOnSubmit || c[b.p.id].checkOnUpdate) c[b.p.id]._savedData[i] = o
                    }),
                    a("#id_g", "#" + h).val(d);
                    else {
                        ...
                        n && (a('td[role="gridcell"]', n).each(function(f) {
                            ...
                            if ("cb" !== i && "subgrid" !== i && "rn" !== i && !0 === m[f].editable) {
                                if (i == e.p.ExpandColumn && !0 === e.p.treeGrid) g = a(this).text();
                                else try {
                                ...
                                case "select":
                                    ...
                                    a("#" + i + " option", "#" + h).each(function() {
                                        this.selected = !m[f].editoptions.multiple && (a.trim(g) == a.trim(a(this).text()) || k[0] == a.trim(a(this).text()) || k[0] == a.trim(a(this).val())) ? !0 : m[f].editoptions.multiple ? -1 < a.inArray(a.trim(a(this).text()), k) || -1 < a.inArray(a.trim(a(this).val()), k) ? !0 : !1 : !1
                                    });
                                    break;
                                case "checkbox":
                                    g += "";
                                    m[f].editoptions && m[f].editoptions.value ? m[f].editoptions.value.split(":")[0] == g ? (a("#" + i, "#" + h)[b.p.useProp ? "prop": "attr"]("checked", !0), a("#" + i, "#" + h)[b.p.useProp ? "prop": "attr"]("defaultChecked", !0)) : (a("#" + i, "#" + h)[b.p.useProp ? "prop": "attr"]("checked", !1), a("#" + i, "#" + h)[b.p.useProp ? "prop": "attr"]("defaultChecked", !1)) : (g = g.toLowerCase(), 0 > g.search(/(false|0|no|off|undefined)/i) && "" !== g ? (a("#" + i, "#" + h)[b.p.useProp ? "prop": "attr"]("checked", !0), a("#" + i, "#" + h)[b.p.useProp ? "prop": "attr"]("defaultChecked", !0)) : (a("#" + i, "#" + h)[b.p.useProp ? "prop": "attr"]("checked", !1), a("#" + i, "#" + h)[b.p.useProp ? "prop": "attr"]("defaultChecked", !1)));
                                    break;
                                case "custom":
                                    try {
                                        if (m[f].editoptions && a.isFunction(m[f].editoptions.custom_value)) m[f].editoptions.custom_value.call(b, a("#" + i, "#" + h), "set", g);
                                        else throw "e1";
                                    } catch(o) {
                                        "e1" == o ? a.jgrid.info_dialog(jQuery.jgrid.errors.errcap, "function 'custom_value' " + a.jgrid.edit.msg.nodefined, jQuery.jgrid.edit.bClose) : a.jgrid.info_dialog(jQuery.jgrid.errors.errcap, o.message, jQuery.jgrid.edit.bClose)
                                    }
                                }
                                q++
                            }
                ...
                function s() {
                    ...
                    p,
                    v,
                    u = a(b).triggerHandler("jqGridAddEditBeforeCheckValues", [a("#" + h), z]);
                    u && "object" === typeof u && (i = u);
                    a.isFunction(c[b.p.id].beforeCheckValues) && (u = c[b.p.id].beforeCheckValues.call(b, i, a("#" + h), "_empty" == i[b.p.id + "_id"] ? q.addoper: q.editoper)) && "object" === typeof u && (i = u);
                    for (n in i) if (i.hasOwnProperty(n) && (f = a.jgrid.checkValues.call(b, i[n], n, b), !1 === f[0])) break;
                    t();
                    f[0] && (g = a(b).triggerHandler("jqGridAddEditClickSubmit", [c[b.p.id], i, z]), void 0 === g && a.isFunction(c[b.p.id].onclickSubmit) && (g = c[b.p.id].onclickSubmit.call(b, c[b.p.id], i) || {}), f = a(b).triggerHandler("jqGridAddEditBeforeSubmit", [i, a("#" + h), z]), void 0 === f && (f = [!0, "", ""]), f[0] && a.isFunction(c[b.p.id].beforeSubmit) && (f = c[b.p.id].beforeSubmit.call(b, i, a("#" + h))));
                    if (f[0] && !c[b.p.id].processing) {
                        ...
                        if (!0 === b.p.treeGrid) for (v in i[l] == q.addoper && (p = a(b).jqGrid("getGridParam", "selrow"), i["adjacency" == b.p.treeGridModel ? b.p.treeReader.parent_id_field: "parent_id"] = p), b.p.treeReader) b.p.treeReader.hasOwnProperty(v) && (g = b.p.treeReader[v], i.hasOwnProperty(g) && !(i[l] == q.addoper && "parent_id_field" === v) && delete i[g]);
                        i[k] = a.jgrid.stripPref(b.p.idPrefix, i[k]);
                        v = a.extend({
                            url: c[b.p.id].url ? c[b.p.id].url: a(b).jqGrid("getGridParam", "editurl"),
                            type: c[b.p.id].mtype,
                            data: a.isFunction(c[b.p.id].serializeEditData) ? c[b.p.id].serializeEditData.call(b, i) : i,
                            complete: function(g, n) {
                                i[k] = b.p.idPrefix + i[k];
                                if (n != "success") {
                                    f[0] = false;
                                    f[1] = a(b).triggerHandler("jqGridAddEditErrorTextFormat", [g, z]);
                                    f[1] = a.isFunction(c[b.p.id].errorTextFormat) ? c[b.p.id].errorTextFormat.call(b, g) : n + " Status: '" + g.statusText + "'. Error code: " + g.status
                                } else {
                                ...
                                if (f[0] === false) {
                                    ...
                                    if (i[l] == q.addoper) {
                                        ...
                                        if (c[b.p.id].closeAfterAdd) {
                                            ...
                                            else if (b.p.treeGrid === true) a(b).jqGrid("addChildNode", f[2], p, i);
                                            else {
                                            ...
                                            c[b.p.id].reloadAfterSubmit ? a(b).trigger("reloadGrid") : b.p.treeGrid === true ? a(b).jqGrid("addChildNode", f[2], p, i) : a(b).jqGrid("addRowData", f[2], i, d.addedrow);
                                            r("_empty", b, h)
                                        ...
                                        if (c[b.p.id].reloadAfterSubmit) {
                                            ...
                                            1E3)
                                        } else b.p.treeGrid === true ? a(b).jqGrid("setTreeRow", i[k], i) : a(b).jqGrid("setRowData", i[k], i);
                                        c[b.p.id].closeAfterEdit && a.jgrid.hideModal("#" + a.jgrid.jqID(o.themodal), {
                                            gb: "#gbox_" + a.jgrid.jqID(m),
                                            jqm: d.jqModal,
                                            onClose: c[b.p.id].onClose
                                        })
                                    ...
                                    if (c[b.p.id].checkOnSubmit || c[b.p.id].checkOnUpdate) {
                                        ...
                                        if (c[b.p.id]._savedData[b.p.id + "_id"] != "_empty") for (var v in c[b.p.id]._savedData) i[v] && (c[b.p.id]._savedData[v] = i[v])
                                    }
                                }
                        ...
                        a.jgrid.ajaxOptions, c[b.p.id].ajaxEditOptions); ! v.url && !c[b.p.id].useDataProxy && (a.isFunction(b.p.dataProxy) ? c[b.p.id].useDataProxy = !0 : (f[0] = !1, f[1] += " " + a.jgrid.errors.nourl));
                        f[0] && (c[b.p.id].useDataProxy ? (g = b.p.dataProxy.call(b, v, "set_" + b.p.id), "undefined" == typeof g && (g = [!0, ""]), !1 === g[0] ? (f[0] = !1, f[1] = g[1] || "Error deleting the selected row!") : (v.data.oper == q.addoper && c[b.p.id].closeAfterAdd && a.jgrid.hideModal("#" + a.jgrid.jqID(o.themodal), {
                            gb: "#gbox_" + a.jgrid.jqID(m),
                            jqm: d.jqModal,
                            onClose: c[b.p.id].onClose
                        }), v.data.oper == q.editoper && c[b.p.id].closeAfterEdit && a.jgrid.hideModal("#" + a.jgrid.jqID(o.themodal), {
                            gb: "#gbox_" + a.jgrid.jqID(m),
                            jqm: d.jqModal,
                            onClose: c[b.p.id].onClose
                        }))) : a.ajax(v))
                ...
                function g() {
                    var d = !0;
                    a("#FormError", j).hide();
                    if (c[b.p.id].checkOnUpdate && (i = {},
                    B = {},
                    e(), F = a.extend({},
                    i, B), M = p(F, c[b.p.id]._savedData))) a("#" + h).data("disabled", !0),
                ...
                if (b.grid && u) {
                    ...
                    z,
                    h = a.jgrid.jqID(h);
                    "new" === u ? (u = "_empty", z = "add", d.caption = c[b.p.id].addCaption) : (d.caption = c[b.p.id].editCaption, z = "edit"); ! 0 === d.recreateForm && null !== a("#" + a.jgrid.jqID(o.themodal)).html() && a("#" + a.jgrid.jqID(o.themodal)).remove();
                    var I = !0;
                    ...
                    if (null !== a("#" + a.jgrid.jqID(o.themodal)).html()) {
                        ...
                        c[b.p.id].bottominfo ? (a(".bottominfo", j + "_2").html(c[b.p.id].bottominfo), a(".binfo", j + "_2").show()) : a(".binfo", j + "_2").hide();
                        r(u, b, h);
                        "_empty" == u || !c[b.p.id].viewPagerButtons ? a("#pData, #nData", j + "_2").hide() : a("#pData, #nData", j + "_2").show(); ! 0 === c[b.p.id].processing && (c[b.p.id].processing = !1, a("#sData", j + "_2").removeClass("ui-state-active")); ! 0 === a("#" + h).data("disabled") && (a(".confirm", "#" + a.jgrid.jqID(o.themodal)).hide(), a("#" + h).data("disabled", !1));
                        ...
                        C = a("<table id='" + k + "' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),
                        q = a(b).triggerHandler("jqGridAddEditBeforeInitData", [a("#" + h), z]);
                        "undefined" == typeof q && (q = !0);
                        q && x && (q = x.call(b, a("#" + h)));
                        if (!1 === q) return;
                        f();
                        ...
                        x[0].rp = 0;
                        a(C).append(x);
                        var q = (x = "rtl" == b.p.direction ? !0 : !1) ? "nData": "pData",
                        D = x ? "pData": "nData";
                        l(u, b, C, v);
                        ...
                        k = "<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='" + k + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>" + (x ? D + q: q + D) + "</td><td class='EditButton'>" + J + K + "</td></tr>" + ("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>" + c[b.p.id].bottominfo + "</td></tr>"),
                        k = k + "</tbody></table>";
                        if (0 < H) {
                            var L = [];
                            a.each(a(C)[0].rows,
                        ...
                        var N = !1; ! 0 === d.closeOnEscape && (d.closeOnEscape = !1, N = !0);
                        k = a("<span></span>").append(G).append(k);
                        a.jgrid.createModal(o, k, d, "#gview_" + a.jgrid.jqID(b.p.id), a("#gbox_" + a.jgrid.jqID(b.p.id))[0]);
                        ...
                        d.checkOnUpdate && (a("a.ui-jqdialog-titlebar-close span", "#" + a.jgrid.jqID(o.themodal)).removeClass("jqmClose"), a("a.ui-jqdialog-titlebar-close", "#" + a.jgrid.jqID(o.themodal)).unbind("click").click(function() {
                            if (!g()) return false;
                            a.jgrid.hideModal("#" + a.jgrid.jqID(o.themodal), {
                                gb: "#gbox_" + a.jgrid.jqID(m),
                                jqm: d.jqModal,
                        ...
                        d.closeicon = a.extend([!0, "left", "ui-icon-close"], d.closeicon); ! 0 === d.saveicon[0] && a("#sData", j + "_2").addClass("right" == d.saveicon[1] ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='ui-icon " + d.saveicon[2] + "'></span>"); ! 0 === d.closeicon[0] && a("#cData", j + "_2").addClass("right" == d.closeicon[1] ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='ui-icon " + d.closeicon[2] + "'></span>");
                        if (c[b.p.id].checkOnSubmit || c[b.p.id].checkOnUpdate) J = "<a href='javascript:void(0)' id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" + d.bYes + "</a>",
                        ...
                        k = d.zIndex || 999,
                        k++,
                        a("<div class='ui-widget-overlay jqgrid-overlay confirm' style='z-index:" + k + ";display:none;'>&#160;" + (a.browser.msie && 6 == a.browser.version ? '<iframe style="display:block;position:absolute;z-index:-1;filter:Alpha(Opacity=\'0\');" src="javascript:false;"></iframe>': "") + "</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:" + (k + 1) + "'>" + d.saveData + "<br/><br/>" + J + D + K + "</div>").insertAfter("#" + h),
                        a("#sNew", "#" + a.jgrid.jqID(o.themodal)).click(function() {
                            s();
                            a("#" + h).data("disabled", false);
        ...
        viewGridRow: function(c, d) {
            ...
            a.jgrid.view, d || {});
            return this.each(function() {
                function e() { (!0 === d.closeOnEscape || !0 === d.navkeys[0]) && setTimeout(function() {
                ...
                function l(b, c, e, f) {
                    ...
                    a(c.p.colModel).each(function() {
                        h = this.editrules && !0 === this.editrules.edithidden ? !1 : !0 === this.hidden ? !0 : !1; ! h && "right" === this.align && (this.formatter && -1 !== a.inArray(this.formatter, s) ? r = Math.max(r, parseInt(this.width, 10)) : t = Math.max(t, parseInt(this.width, 10)))
                    });
                    y = 0 !== r ? r: 0 !== t ? t: 0;
                    ...
                    a(c.p.colModel).each(function(b) {
                        ...
                        if ("cb" !== g && "subgrid" !== g && "rn" !== g && w) {
                            ...
                            this.formoptions || {}),
                            q = parseInt(d.rowpos, 10) || j + 1,
                            p = parseInt(2 * (parseInt(d.colpos, 10) || 1), 10);
                            if (d.rowabove) {
                    ...
                    0 < j && (b = a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" + (2 * f - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='" + b + "'/></td></tr>"), b[0].rp = j + 99, a(e).append(b));
                    return l
                }
                function r(b, c) {
                    var d, e, f = 0,
                    ...
                    if (h = a(c).jqGrid("getInd", b, !0)) a("td", h).each(function(b) {
                        ...
                        c.p.colModel[b].editoptions || {}), d = a.jgrid.jqID("v_" + d), a("#" + d + " span", "#" + n).html(g), e && a("#" + d, "#" + n).parents("tr:first").hide(), f++)
                    }),
                    0 < f && a("#id_g", "#" + n).val(b)
                }
                function t(b, c) {
                ...
                if (p.grid && c) {
                    ...
                    if (null !== a("#" + a.jgrid.jqID(m.themodal)).html()) {
                        ...
                        w = a("<form name='FormPost' id='" + w + "' class='FormGrid' style='width:100%;overflow:auto;position:relative;height:" + y + ";'></form>"),
                        A = a("<table id='" + b + "' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");
                        h && (k = h.call(p, a("#" + f)), "undefined" == typeof k && (k = !0));
                        if (!1 === k) return;
                        ...
                        var E = !1; ! 0 === d.closeOnEscape && (d.closeOnEscape = !1, E = !0);
                        w = a("<span></span>").append(w).append("<table border='0' class='EditTable' id='" + n + "_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='" + d.labelswidth + "'>" + (b ? k + h: h + k) + "</td><td class='EditButton'>" + y + "</td></tr></tbody></table>");
                        ...
                        d.closeicon = a.extend([!0, "left", "ui-icon-close"], d.closeicon); ! 0 === d.closeicon[0] && a("#cData", "#" + n + "_2").addClass("right" == d.closeicon[1] ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='ui-icon " + d.closeicon[2] + "'></span>");
                        a.isFunction(d.beforeShowForm) && d.beforeShowForm.call(p, a("#" + f));
                        a.jgrid.viewModal("#" + a.jgrid.jqID(m.themodal), {
                            gbox: "#gbox_" + a.jgrid.jqID(g),
                            jqm: d.jqModal,
        ...
        delGridRow: function(u, d) {
            ...
            return this.each(function() {
                var e = this;
                if (e.grid && u) {
                    var l = a.isFunction(c[e.p.id].beforeShowForm),
                    r = a.isFunction(c[e.p.id].afterShowForm),
                    t = a.isFunction(c[e.p.id].beforeInitData) ? c[e.p.id].beforeInitData: !1,
                    s = e.p.id,
                    p = {},
                    g = !0,
                    f = "DelTbl_" + a.jgrid.jqID(s),
                    n,
                    w,
                    b,
                    m,
                    ...
                    if (null !== a("#" + a.jgrid.jqID(k.themodal)).html()) {
                        ...
                        a("#DelError", "#" + f).hide(); ! 0 === c[e.p.id].processing && (c[e.p.id].processing = !1, a("#dData", "#" + f).removeClass("ui-state-active"));
                        l && c[e.p.id].beforeShowForm.call(e, a("#" + f));
                        a.jgrid.viewModal("#" + a.jgrid.jqID(k.themodal), {
                        ...
                        var j = isNaN(c[e.p.id].dataheight) ? c[e.p.id].dataheight: c[e.p.id].dataheight + "px",
                        h = "<div id='" + h + "' class='formdata' style='width:100%;overflow:auto;position:relative;height:" + j + ";'><table class='DelTable'><tbody><tr id='DelError' style='display:none'><td class='ui-state-error'></td></tr>" + ("<tr id='DelData' style='display:none'><td >" + u + "</td></tr>"),
                        ...
                        d.cancelicon = a.extend([!0, "left", "ui-icon-cancel"], c[e.p.id].cancelicon); ! 0 === d.delicon[0] && a("#dData", "#" + f + "_2").addClass("right" == d.delicon[1] ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='ui-icon " + d.delicon[2] + "'></span>"); ! 0 === d.cancelicon[0] && a("#eData", "#" + f + "_2").addClass("right" == d.cancelicon[1] ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='ui-icon " + d.cancelicon[2] + "'></span>");
                        a("#dData", "#" + f + "_2").click(function() {
                            ...
                            if (g[0] && !c[e.p.id].processing) {
                                ...
                                j = a.extend({
                                    ...
                                    type: c[e.p.id].mtype,
                                    data: a.isFunction(c[e.p.id].serializeDelData) ? c[e.p.id].serializeDelData.call(e, n) : n,
                                    complete: function(b, j) {
                                        ...
                                        if (g[0] === false) {
                                            ...
                                            if (c[e.p.id].reloadAfterSubmit && e.p.datatype != "local") a(e).trigger("reloadGrid");
                                                ...
                                                } catch(m) {} else for (var l = 0; l < h.length; l++) a(e).jqGrid("delRowData", e.p.idPrefix + h[l]);
                                                e.p.selrow = null;
                                                e.p.selarrrow = []
                                            }
                                        ...
                                        g[0] && a.jgrid.hideModal("#" + a.jgrid.jqID(k.themodal), {
                                ...
                                if (!j.url && !c[e.p.id].useDataProxy) if (a.isFunction(e.p.dataProxy)) c[e.p.id].useDataProxy = true;
                                else {
                                    g[0] = false;
                                ...
                                if (g[0]) if (c[e.p.id].useDataProxy) {
                                    ...
                                    } else a.jgrid.hideModal("#" + a.jgrid.jqID(k.themodal), {
                                        gb: "#gbox_" + a.jgrid.jqID(s),
                                        jqm: d.jqModal,
                                        onClose: c[e.p.id].onClose
                                    })
                    ...
                    r && c[e.p.id].afterShowForm.call(e, a("#" + f)); ! 0 === c[e.p.id].closeOnEscape && setTimeout(function() {
                        a(".ui-jqdialog-titlebar-close", "#" + a.jgrid.jqID(k.modalhead)).focus()
                    },
                    0)
                }
            })
            ...
            return this.each(function() {
                if (!this.nav) {
                    ...
                    if (g.grid && "string" == typeof c) {
                        ...
                        for (var w = 0; w < n; w++) {
                            var b = a("<table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"),
                            m,
                            h;
                            ...
                            d.add && (l = l || {},
                            f = a("<td class='ui-pg-button ui-corner-all'></td>"), a(f).append("<div class='ui-pg-div'><span class='ui-icon " + d.addicon + "'></span>" + d.addtext + "</div>"), a("tr", b).append(f), a(f, b).attr({
                                title: d.addtitle || "",
                                id: l.id || "add_" + h
                            }).click(function() {
                            ...
                            d.edit && (f = a("<td class='ui-pg-button ui-corner-all'></td>"), e = e || {},
                            a(f).append("<div class='ui-pg-div'><span class='ui-icon " + d.editicon + "'></span>" + d.edittext + "</div>"), a("tr", b).append(f), a(f, b).attr({
                                title: d.edittitle || "",
                                id: e.id || "edit_" + h
                            }).click(function() {
                            ...
                            d.view && (f = a("<td class='ui-pg-button ui-corner-all'></td>"), s = s || {},
                            a(f).append("<div class='ui-pg-div'><span class='ui-icon " + d.viewicon + "'></span>" + d.viewtext + "</div>"), a("tr", b).append(f), a(f, b).attr({
                                title: d.viewtitle || "",
                                id: s.id || "view_" + h
                            }).click(function() {
                                if (!a(this).hasClass("ui-state-disabled")) {
                                    var b = g.p.selrow;
                                    if (b) a.isFunction(d.viewfunc) ? d.viewfunc.call(g, b) : a(g).jqGrid("viewGridRow", b, s);
                                    else {
                                        a.jgrid.viewModal("#" + p.themodal, {
                                            gbox: "#gbox_" + a.jgrid.jqID(g.p.id),
                                            jqm: true
                            ...
                            d.del && (f = a("<td class='ui-pg-button ui-corner-all'></td>"), r = r || {},
                            a(f).append("<div class='ui-pg-div'><span class='ui-icon " + d.delicon + "'></span>" + d.deltext + "</div>"), a("tr", b).append(f), a(f, b).attr({
                                title: d.deltitle || "",
                                id: r.id || "del_" + h
                            }).click(function() {
                                if (!a(this).hasClass("ui-state-disabled")) {
                            ...
                            d.search && (f = a("<td class='ui-pg-button ui-corner-all'></td>"), t = t || {},
                            a(f).append("<div class='ui-pg-div'><span class='ui-icon " + d.searchicon + "'></span>" + d.searchtext + "</div>"), a("tr", b).append(f), a(f, b).attr({
                                title: d.searchtitle || "",
                                id: t.id || "search_" + h
                            }).click(function() {
                            ...
                            d.refresh && (f = a("<td class='ui-pg-button ui-corner-all'></td>"), a(f).append("<div class='ui-pg-div'><span class='ui-icon " + d.refreshicon + "'></span>" + d.refreshtext + "</div>"), a("tr", b).append(f), a(f, b).attr({
            ...
            return this.each(function() {
                ...
                if (e.grid) {
                    ...
                    if (l) for (var r in l) a("[name=" + a.jgrid.jqID(r) + "]", d).is("input:radio") || a("[name=" + a.jgrid.jqID(r) + "]", d).is("input:checkbox") ? a("[name=" + a.jgrid.jqID(r) + "]", d).each(function() {
                        if (a(this).val() == l[r]) a(this)[e.p.useProp ? "prop": "attr"]("checked", !0);
                ...
                if (n) {
                    ...
                    this.createTableForGroup = function(g, k) {
                        ...
                        if (!0 === this.p.ruleButtons) {
                            ...
                            var h = "",
                            f;
                            for (c = 0; c < o.groupOps.length; c++) f = g.groupOp === b.p.groupOps[c].op ? " selected='selected'": "",
                        ...
                        if (!0 === this.p.ruleButtons) {
                            ...
                            function() {
                                ...
                                g.rules.push({
                                    field: l.name,
                                    op: (l.searchoptions.sopt ? l.searchoptions.sopt: b.p.sopt ? b.p.sopt: l.searchtype === "string" ? b.p.stropts: b.p.numopts)[0],
                                    data: ""
                                });
                                b.reDraw();
                                return false
                    ...
                    this.createTableRowForRule = function(g, d) {
                        ...
                        function() {
                            ...
                            if (i) {
                                ...
                                for (e = 0; e < f.length; e++) p = a.inArray(f[e], q),
                        ...
                        for (e = 0; e < f.length; e++) p = a.inArray(f[e], q),
                        -1 !== p && (l = g.op === b.p.ops[p].name ? " selected='selected'": "", j += "<option value='" + b.p.ops[p].name + "'" + l + ">" + b.p.ops[p].description + "</option>");
                        s.append(j);
    ...
    a.jgrid.extend({
        editRow: function(c, d, b, o, h, f, n, l, e) {
            ...
            return this.each(function() {
                ...
                l = {},
                f, k;
                if (e.grid && (f = a(e).jqGrid("getInd", c, !0), !1 !== f && "0" == (a(f).attr("editable") || "0") && !a(f).hasClass("not-editable-row"))) k = e.p.colModel,
                a('td[role="gridcell"]', f).each(function(f) {
                    d = k[f].name;
                    ...
                    if ("cb" != d && "subgrid" != d && "rn" != d && (e.p.autoencode && (b = a.jgrid.htmlDecode(b)), l[d] = b, !0 === k[f].editable)) {
                        ...
                        t = a.jgrid.createEl.call(e, k[f].edittype, t, b, !0, a.extend({},
                        a.jgrid.ajaxOptions, e.p.ajaxSelectOptions || {}));
                ...
                0 < g && (l.id = c, e.p.savedRow.push(l), a(f).attr("editable", "1"), a("td:eq(" + h + ") input", f).focus(), !0 === j.keys && a(f).bind("keydown",
                function(b) {
                    if (27 === b.keyCode) {
                        a(e).jqGrid("restoreRow", c, j.afterrestorefunc);
                        if (e.p._inlinenav) try {
                            a(e).jqGrid("showAddEditButtons")
                        } catch(d) {}
                        return ! 1
                    }
                    //disable  enter keypress POST inline edit
                    /*if (13 === b.keyCode) {
        ...
        saveRow: function(c, d, b, o, h, f, n) {
            ...
            else if (a.isFunction(d) && (e.successfunc = d), "undefined" !== typeof b && (e.url = b), "undefined" !== typeof o && (e.extraparam = o), a.isFunction(h) && (e.aftersavefunc = h), a.isFunction(f) && (e.errorfunc = f), a.isFunction(n)) e.afterrestorefunc = n;
            var e = a.extend(!0, {
                successfunc: null,
                url: null,
                extraparam: {},
            ...
            if ("1" === l) {
                ...
                a('td[role="gridcell"]', q).each(function(b) {
                    ...
                    if ("cb" != m && "subgrid" != m && !0 === k.editable && "rn" != m && !a(this).hasClass("not-editable-cell")) {
                        ...
                        case "select":
                            ...
                            v[m] = a("select option:selected", this).text();
                        ...
                        case "custom":
                            try {
                                ...
                                "e1" == f && a.jgrid.info_dialog(a.jgrid.errors.errcap, "function 'custom_value' " + a.jgrid.edit.msg.nodefined, a.jgrid.edit.bClose),
                                "e2" == f ? a.jgrid.info_dialog(a.jgrid.errors.errcap, "function 'custom_value' " + a.jgrid.edit.msg.novalue, a.jgrid.edit.bClose) : a.jgrid.info_dialog(a.jgrid.errors.errcap, f.message, a.jgrid.edit.bClose)
                            }
                        }
                        ...
                        "clientArray" !== e.url && k.editoptions && !0 === k.editoptions.NullIfEmpty && "" === i[m] && (r[m] = "null")
                    }
                });
                if (!1 === s[0]) {
                    try {
                ...
                w = l.oper;
                p = l.id;
                i && (i[w] = l.editoper, i[p] = c, "undefined" == typeof g.p.inlineData && (g.p.inlineData = {}), i = a.extend({},
                i, g.p.inlineData, e.extraparam));
                if ("clientArray" == e.url) {
                    i = a.extend({},
                    i, v);
                    g.p.autoencode && a.each(i,
                    function(e, b) {
                        i[e] = a.jgrid.htmlDecode(b)
                    });
                    p = a(g).jqGrid("setRowData", c, i);
                    a(q).attr("editable", "0");
                    for (l = 0; l < g.p.savedRow.length; l++) if (g.p.savedRow[l].id == c) {
                        u = l;
                        break
                    }
                    ...
                    j = !0;
                    a(q).unbind("keydown")
                } else a("#lui_" + a.jgrid.jqID(g.p.id)).show(),
                r = a.extend({},
                i, r),
                r[p] = a.jgrid.stripPref(g.p.idPrefix, r[p]),
                a.ajax(a.extend({
                    url: e.url,
                    data: a.isFunction(g.p.serializeRowData) ? g.p.serializeRowData.call(g, r) : r,
                    type: e.mtype,
                    async: !1,
                    complete: function(b, d) {
                        ...
                        if (d === "success") {
                            ...
                            if (f === true) {
                                ...
                                a(q).attr("editable", "0");
                                for (f = 0; f < g.p.savedRow.length; f++) if (g.p.savedRow[f].id == c) {
                                    u = f;
                                    break
                                }
        ...
        restoreRow: function(c, d) {
            ...
            o = {};
            "object" === a.type(b[0]) ? o = b[0] : a.isFunction(d) && (o.afterrestorefunc = d);
        ...
        addRow: function(c) {
            ...
            return this.each(function() {
                if (this.grid) {
                    var d = this; ! 0 === c.useDefValues && a(d.p.colModel).each(function() {
            ...
            return this.each(function() {
                if (this.grid) {
                    ...
                    if (!0 === d.addParams.useFormatter) {
                        var f = b.p.colModel,
                        n;
                        for (n = 0; n < f.length; n++) if (f[n].formatter && "actions" === f[n].formatter) {
                    ...
                    if (null !== c) {
                        ...
                        case "custom":
                            try {
                                ...
                                "e1" == o && b.jgrid.info_dialog(jQuery.jgrid.errors.errcap, "function 'custom_value' " + b.jgrid.edit.msg.nodefined, jQuery.jgrid.edit.bClose),
                                "e2" == o ? b.jgrid.info_dialog(jQuery.jgrid.errors.errcap, "function 'custom_value' " + b.jgrid.edit.msg.novalue, jQuery.jgrid.edit.bClose) : b.jgrid.info_dialog(jQuery.jgrid.errors.errcap, o.message, jQuery.jgrid.edit.bClose)
                            }
                        }
        ...
        nextCell: function(d, f) {
            return this.each(function() {
                ...
                if (this.grid && !0 === this.p.cellEdit) {
                    for (var c = f + 1; c < this.p.colModel.length; c++) if (!0 === this.p.colModel[c].editable) {
                        a = c;
                        break
...
(function(b) {
    ...
    i = b.jqm.hash,
    j = [],
    p = b.browser.msie && "6.0" == b.browser.version,
    d = !1,
    q = function(a) {
            ...
            return this.each(function() {
                ...
                if (a.grid) {
                    ...
                    n = function(c, d) {
                        ...
                        b(i).append(h);
                        b(e).append(i);
                        c && (o = a.p.xmlReader.subgrid, b(o.root + " " + o.row, c).each(function() {
                    ...
                    p = function(c, d) {
                        var h, f, e, g, i, k = b("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),
                        j = b("<tr></tr>");
                        for (f = 0; f < a.p.subGridModel[0].name.length; f++) h = b("<th class='ui-state-default ui-th-subgrid ui-th-column ui-th-" + a.p.direction + "'></th>"),
                        b(h).html(a.p.subGridModel[0].name[f]),
                        b(h).width(a.p.subGridModel[0].width[f]),
                    ...
                    t = function(c) {
                        ...
                        if (a.p.subGridModel[0].params) for (g = 0; g < a.p.subGridModel[0].params.length; g++) for (f = 0; f < a.p.colModel.length; f++) a.p.colModel[f].name === a.p.subGridModel[0].params[g] && (e[a.p.colModel[f].name] = b("td:eq(" + f + ")", c).text().replace(/\&#160\;/ig, ""));
                    ...
                    function() {
                        ...
                        if (b(this).hasClass("sgcollapsed")) {
                            ...
                            if (a.p.subGridOptions.reloadOnExpand === true || a.p.subGridOptions.reloadOnExpand === false && !b(j).hasClass("ui-subgrid")) {
                                ...
                                b(c).after("<tr role='row' class='ui-subgrid'>" + q + "<td class='ui-widget-content subgrid-cell'><span class='ui-icon " + a.p.subGridOptions.openicon + "'></span></td><td colspan='" + parseInt(a.p.colNames.length - 1 - r, 10) + "' class='ui-widget-content subgrid-data'><div id=" + k + "_" + e + " class='tablediv'></div></td></tr>");
                    ...
                    !0 === a.p.subGridOptions.expandOnLoad && b(a.rows[l].cells[d]).trigger("click"),
                    l++;
    ...
    e.jgrid.extend({
        groupingSetup: function() {
            return this.each(function() {
                ...
                if (null !== a && ("object" === typeof a || e.isFunction(a))) if (a.groupField.length) {
                    "undefined" == typeof a.visibiltyOnNextGrouping && (a.visibiltyOnNextGrouping = []);
                    for (var c = 0; c < a.groupField.length; c++) if (a.groupOrder[c] || (a.groupOrder[c] = "asc"), a.groupText[c] || (a.groupText[c] = "{0}"), "boolean" != typeof a.groupColumnShow[c] && (a.groupColumnShow[c] = !0), "boolean" != typeof a.groupSummary[c] && (a.groupSummary[c] = !1), !0 === a.groupColumnShow[c] ? (a.visibiltyOnNextGrouping[c] = !0, e(this).jqGrid("showCol", a.groupField[c])) : (a.visibiltyOnNextGrouping[c] = e("#" + e.jgrid.jqID(this.p.id + "_" + a.groupField[c])).is(":visible"), e(this).jqGrid("hideCol", a.groupField[c])), a.sortitems[c] = [], a.sortnames[c] = [], a.summaryval[c] = [], a.groupSummary[c]) {
                        a.summary[c] = [];
            ...
            this.each(function() {
                ...
                if (l.hasClass(g)) {
                    if (c.showSummaryOnHide && c.groupSummary[0]) {
                        if (f) for (; f && !e(f).hasClass("jqfoot");) e(f).hide(),
                        f = f.nextSibling
                    } else if (f) for (; f && e(f).attr("id") != d + ("" + b);) e(f).hide(),
                    f = f.nextSibling;
                    l.removeClass(g).addClass(h);
                    m = !0
                } else {
                    if (f) for (; f && e(f).attr("id") != d + ("" + b);) e(f).show(),
                    f = f.nextSibling;
        ...
        groupingRender: function(a, c) {
            return this.each(function() {
                ...
                q,
                i;
                d.groupDataSorted || (d.sortitems[0].sort(), d.sortnames[0].sort(), "desc" == d.groupOrder[0].toLowerCase() && (d.sortitems[0].reverse(), d.sortnames[0].reverse()));
                ...
                function(i, n) {
                    f = b.p.id + "ghead_" + i;
                    h = "<span style='cursor:pointer;' class='ui-icon " + l + "' onclick=\"jQuery('#" + e.jgrid.jqID(b.p.id) + "').jqGrid('groupingToggle','" + f + "');return false;\"></span>";
                    try {
                        m = b.formatter(f, d.sortnames[0][i], q, d.sortitems[0])
                    } catch(u) {
                        m = d.sortnames[0][i]
                    }
                    g = g + ('<tr id="' + f + '" role="row" class= "ui-widget-content jqgroup ui-row-' + b.p.direction + '"><td colspan="' + c + '">' + h + e.jgrid.format(d.groupText[0], m, a[n].length) + "</td></tr>");
                    ...
                    if (d.groupSummary[0]) {
                        ...
                        for (var j = d.summaryval[0][n], o = b.p.colModel, p, r = a[n].length, k = 0; k < c; k++) {
                            ...
                            function() {
                                if (this.nm == o[k].name) {
                                    if (o[k].summaryTpl) t = o[k].summaryTpl;
        ...
        groupingRemove: function(a) {
            return this.each(function() {
                ...
                this.p.grouping = !1;
                if (!0 === a) {
                    for (var c = this.p.groupingView, b = 0; b < c.groupField.length; b++) ! c.groupColumnShow[b] && c.visibiltyOnNextGrouping[b] && e(this).jqGrid("showCol", c.groupField);
...
(function(d) {
    d.jgrid.extend({
        setTreeNode: function(a, b) {
            return this.each(function() {
                var c = this;
                if (c.grid && c.p.treeGrid) for (var e = c.p.expColInd, g = c.p.treeReader.expanded_field, h = c.p.treeReader.leaf_field, f = c.p.treeReader.level_field, l = c.p.treeReader.icon_field, j = c.p.treeReader.loaded, i, p, m, k; a < b;) k = c.p.data[c.p._index[c.rows[a].id]],
                "nested" == c.p.treeGridModel && !k[h] && (i = parseInt(k[c.p.treeReader.left_field], 10), p = parseInt(k[c.p.treeReader.right_field], 10), k[h] = p === i + 1 ? "true": "false", c.rows[a].cells[c.p._treeleafpos].innerHTML = k[h]),
                i = parseInt(k[f], 10),
                0 === c.p.tree_root_level ? (m = i + 1, p = i) : (m = i, p = i - 1),
                m = "<div class='tree-wrap tree-wrap-" + c.p.direction + "' style='width:" + 18 * m + "px;'>",
                m += "<div style='" + ("rtl" == c.p.direction ? "right:": "left:") + 18 * p + "px;' class='ui-icon ",
                void 0 !== k[j] && (k[j] = "true" == k[j] || !0 === k[j] ? !0 : !1),
                "true" == k[h] || !0 === k[h] ? (m += (void 0 !== k[l] && "" !== k[l] ? k[l] : c.p.treeIcons.leaf) + " tree-leaf treeclick", k[h] = !0, p = "leaf") : (k[h] = !1, p = ""),
                k[g] = ("true" == k[g] || !0 === k[g] ? !0 : !1) && k[j],
                m = !1 === k[g] ? m + (!0 === k[h] ? "'": c.p.treeIcons.plus + " tree-plus treeclick'") : m + (!0 === k[h] ? "'": c.p.treeIcons.minus + " tree-minus treeclick'"),
                m += "></div></div>",
                d(c.rows[a].cells[e]).wrapInner("<span class='cell-wrapper" + p + "'></span>").prepend(m),
                i !== parseInt(c.p.tree_root_level, 10) && ((k = (k = d(c).jqGrid("getNodeParent", k)) && k.hasOwnProperty(g) ? k[g] : !0) || d(c.rows[a]).css("display", "none")),
                d(c.rows[a].cells[e]).find("div.treeclick").bind("click",
                function(a) {
                    a = d(a.target || a.srcElement, c.rows).closest("tr.jqgrow")[0].id;
                    a = c.p._index[a];
                    if (!c.p.data[a][h]) if (c.p.data[a][g]) {
                ...
                !0 === c.p.ExpandColClick && d(c.rows[a].cells[e]).find("span.cell-wrapper").css("cursor", "pointer").bind("click",
                function(a) {
                    var a = d(a.target || a.srcElement, c.rows).closest("tr.jqgrow")[0].id,
                    b = c.p._index[a];
                    if (!c.p.data[b][h]) if (c.p.data[b][g]) {
                        d(c).jqGrid("collapseRow", c.p.data[b]);
                        d(c).jqGrid("collapseNode", c.p.data[b])
                    } else {
        ...
        collapseRow: function(a) {
            this.each(function() {
                ...
                if (b.grid && b.p.treeGrid) {
                    ...
                    d(c).each(function() {
                        var a = d.jgrid.getAccessor(this, b.p.localReader.id);
                        d(g.namedItem(a)).css("display", "none");
        ...
        getRootNodes: function() {
            ...
            this.each(function() {
                ...
                case "adjacency":
                    ...
                    d(b.p.data).each(function() { (null === this[e] || "null" == ("" + this[e]).toLowerCase()) && a.push(this)
                    })
                }
            });
            return a
            ...
            this.each(function() {
                ...
                case "nested":
                    ...
                    d(this.p.data).each(function() {
                        if (parseInt(this[g], 10) === l - 1 && parseInt(this[c], 10) < h && parseInt(this[e], 10) > f) return b = this,
                        !1
                    });
                    break;
                case "adjacency":
        ...
        getNodeAncestors: function(a) {
            var b = [];
            this.each(function() {
                if (this.grid && this.p.treeGrid) for (var c = d(this).jqGrid("getNodeParent", a); c;) b.push(c),
                c = d(this).jqGrid("getNodeParent", c)
            });
            return b
        },
        ...
        collapseNode: function(a) {
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    var b = this.p.treeReader.expanded_field;
                    a[b] && (a[b] = !1, b = d.jgrid.getAccessor(a, this.p.localReader.id), b = d("#" + d.jgrid.jqID(b), this.grid.bDiv)[0], d("div.treeclick", b).removeClass(this.p.treeIcons.minus + " tree-minus").addClass(this.p.treeIcons.plus + " tree-plus"))
                }
            })
        },
        SortTree: function(a, b, c, e) {
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    ...
                    i = g.select();
                    g = 0;
                    for (h = i.length; g < h; g++) f = i[g],
                    l.push(f),
                    d(this).jqGrid("collectChildrenSortTree", l, f, a, b, c, e);
                    d.each(l,
                    function(a) {
                        var b = d.jgrid.getAccessor(this, j.p.localReader.id);
        ...
        collectChildrenSortTree: function(a, b, c, e, g, h) {
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    ...
                    i = f.select();
                    f = 0;
                    for (l = i.length; f < l; f++) j = i[f],
                    a.push(j),
                    d(this).jqGrid("collectChildrenSortTree", a, j, c, e, g, h)
                }
            })
        },
        setTreeRow: function(a, b) {
            var c = !1;
            this.each(function() {
                this.grid && this.p.treeGrid && (c = d(this).jqGrid("setRowData", a, b))
            });
            return c
        },
            ...
            return this.each(function() {
                ...
                if (this.grid && this.p.treeGrid) {
                    ...
                    if (void 0 !== l) {
                        ...
                        if (0 < l.length) for (var j = 0; j < l.length; j++) d(this).jqGrid("delRowData", l[j][b]);
                        if ("nested" === this.p.treeGridModel) {
                            b = d.jgrid.from(this.p.data).greater(c, g, {
                                stype: "integer"
                            }).select();
                            if (b.length) for (f in b) b.hasOwnProperty(f) && (b[f][c] = parseInt(b[f][c], 10) - h);
                            b = d.jgrid.from(this.p.data).greater(e, g, {
                                stype: "integer"
                            }).select();
                            if (b.length) for (f in b) b.hasOwnProperty(f) && (b[f][e] = parseInt(b[f][e], 10) - h)
                        }
                    }
                }
            })
        ...
        addChildNode: function(a, b, c) {
            ...
            if (c) {
                ...
                if ("undefined" === typeof a || null === a) {
                    o = e.p.data.length - 1;
                    if (0 <= o) for (; 0 <= o;) m = Math.max(m, parseInt(e.p.data[o][e.p.localReader.id], 10)),
                    o--;
                    a = m + 1
                }
                var u = d(e).jqGrid("getInd", b);
                t = !1;
                if (void 0 === b || null === b || "" === b) r = b = null,
                m = "last",
                s = e.p.tree_root_level,
                o = e.p.data.length + 1;
                else if (m = "after", k = e.p._index[b], q = e.p.data[k], b = q[e.p.localReader.id], s = parseInt(q[f], 10) + 1, o = d(e).jqGrid("getFullTreeNode", q), o.length ? (r = o = o[o.length - 1][e.p.localReader.id], o = d(e).jqGrid("getInd", r) + 1) : o = d(e).jqGrid("getInd", b) + 1, q[h]) t = !0,
                q[g] = !0,
                ...
                if ("nested" === e.p.treeGridModel) {
                    ...
                    if (null !== b) {
                        ...
                        if (f.length) for (n in f) f.hasOwnProperty(n) && (f[n][i] = parseInt(f[n][i], 10) + 2);
                        c[j] = h + 1;
                        c[i] = h + 2
                    }
                }
                if (null === b || d(e).jqGrid("isNodeLoaded", q) || t) d(e).jqGrid("addRowData", a, c, m, r),
                d(e).jqGrid("setTreeNode", o, k);
