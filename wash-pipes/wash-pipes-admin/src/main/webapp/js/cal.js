...
(function($) { // create private scope (inside you can use $ instead of jQuery)
	...
	var Antonismonth =today.getMonth()+1;
    ...
    $.fn.simpleDatepicker = function(options) {
		...
		function DateDiff(sDate1, sDate2) { // sDate1和sDate2是2002-12-18格式
			// alert("1");
			var iDays = parseInt(Math.abs(sDate1 - sDate2) / 1000 / 60 / 60
					/ 24);
			// alert("2"+ iDays );
			if ((sDate1 - sDate2) < 0) {
				return -iDays;
		...
		function closeIt (el, datepicker, dateObj) { 
		  ...
		  //  var flag;
            ...
            var endArray = jQuery.fn.simpleDatepicker.formatOutput(dateObj).split("/");

			var star = new Date(today.getFullYear(), Antonismonth, today
					.getDate());

			var end = new Date(endArray[0], endArray[1], endArray[2]);
			
			//alert(DateDiff(end,star));
