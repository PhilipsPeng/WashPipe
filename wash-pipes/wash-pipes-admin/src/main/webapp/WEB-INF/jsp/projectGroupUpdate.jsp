...
<script type="text/javascript">
	$(function() {
		$("#projectGroupUpdateForm").validate({
			errorClass : "errors",
			rules : {
				id : {
					required : true
...
<body leftmargin="8" topmargin="8">
	<form:form id="projectGroupUpdateForm" commandName="projectGroup"
		action="projectGroupUpdateSubmit.html" method="post">
		<table width="60%" align="center" border="0" cellpadding="3"
			...
			<tr bgcolor="#FFFFFF">
				...
				<td width="70%" bgcolor="#FFFFFF"><form:input path="id" readonly="true"
